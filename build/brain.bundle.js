...
var d = class {
    ...
    eq(e) {
        ...
        let t = this.scanIdentical(e, 1), n = this.length - this.scanIdentical(e, -1), i = new x(this), l = new x(e);
        for(let h = t, u = t;;){
...
`, this;
    ...
    constructor(e, t, n){
        this.value = "", this.done = !1, this.cursor = new x(e, t > n ? -1 : 1), this.pos = t > n ? e.length : 0, this.from = Math.min(t, n), this.to = Math.max(t, n);
    }
    nextInner(e, t) {
...
var V = class {
    ...
    extend(e, t = e) {
        if (e <= this.anchor && t >= this.anchor) return p35.range(e, t);
        let n = Math.abs(e - this.anchor) > Math.abs(t - this.anchor) ? e : t;
        return p35.range(this.anchor, n);
    }
    eq(e) {
    ...
    static fromJSON(e) {
        ...
        return p35.range(e.anchor, e.head);
    }
}, p35 = class {
    constructor(e, t = 0){
    ...
    map(e, t = -1) {
        return e.empty ? this : p35.create(this.ranges.map((n)=>n.map(e, t)
        ), this.mainIndex);
    }
    eq(e) {
    ...
    asSingle() {
        return this.ranges.length == 1 ? this : new p35([
            this.main
        ]);
    }
    addRange(e, t = !0) {
    ...
    replaceRange(e, t = this.mainIndex) {
        ...
        return n[t] = e, p35.create(n, this.mainIndex);
    }
    toJSON() {
        return {
    ...
    static fromJSON(e) {
        ...
        return new p35(e.ranges.map((t)=>R1.fromJSON(t)
        ), e.main);
    }
    static single(e, t = e) {
        return new p35([
...
function ue(l, e = 0) {
    ...
    for(let n = 1; n < l.length; n++){
        ...
        if (i.empty ? i.from <= s.to : i.from < s.to) {
            ...
            n <= e && e--, l.splice(--n, 2, i.anchor > i.head ? p35.range(o, r) : p35.range(r, o));
        }
    }
    return new p35(l, e);
}
...
var Ie = {
    lowest: N1(b1.lowest),
    low: N1(b1.low),
    default: N1(b1.default),
    high: N1(b1.high),
    highest: N1(b1.highest),
    fallback: N1(b1.lowest),
    extend: N1(b1.high),
    override: N1(b1.highest)
}, Q17 = class {
    constructor(e, t){
...
var te = O1.define(), ne = O1.define({
    ...
    map(e) {
        ...
        return t === void 0 ? void 0 : t == this.value ? this : new v3(this.type, t);
    }
    is(e) {
        return this.type == e;
    }
...
function he(l, e, t) {
    ...
    return t ? (i = e.changes, s = y1.empty(e.changes.length), r = l.changes.compose(e.changes)) : (i = e.changes.map(l.changes), s = l.changes.mapDesc(e.changes, !0), r = l.changes.compose(i)), {
        ...
        effects: v3.mapEffects(l.effects, i).concat(v3.mapEffects(e.effects, s)),
...
function X(l, e, t) {
    ...
    return e.userEvent && (i = i.concat(A1.userEvent.of(e.userEvent))), {
        ...
        selection: n && (n instanceof p35 ? n : p35.single(n.anchor, n.head)),
...
function ye(l) {
    ...
    if (t !== !0) {
        ...
        l = new A1(e, i, l.selection && l.selection.map(s), v3.mapEffects(l.effects, s), l.annotations, l.scrollIntoView);
    }
    let n = e.facet(re);
...
var w1 = class {
    ...
    applyTransaction(e) {
        ...
        ), t = null), i.set(r.value.compartment, r.value.extension)) : r.is(v3.reconfigure) ? (t = null, n = r.value) : r.is(v3.appendConfig) && (t = null, n = P1(n).concat(r.value));
        let s;
    ...
    replaceSelection(e) {
        return typeof e == "string" && (e = this.toText(e)), this.changeByRange((t)=>({
                ...
                range: p35.cursor(t.from + e.length)
            })
        );
    }
    changeByRange(e) {
        ...
        for(let o = 1; o < t.ranges.length; o++){
            ...
            let c = i.mapDesc(f, !0);
            s.push(a.range.map(c)), i = i.compose(h), r = v3.mapEffects(r, h).concat(v3.mapEffects(P1(a.effects), c));
        }
        return {
            changes: i,
            selection: p35.create(s, t.mainIndex),
            effects: r
        };
    }
    changes(e = []) {
    ...
    static fromJSON(e, t = {
        ...
        return w1.create({
            doc: e.doc,
            selection: p35.fromJSON(e.selection),
    ...
    static create(e = {
        ...
        let { configuration: t , values: n  } = L.resolve(e.extensions || [], new Map), i = e.doc instanceof d ? e.doc : d.of((e.doc || "").split(t.staticFacet(w1.lineSeparator) || U)), s = e.selection ? e.selection instanceof p35 ? e.selection : p35.single(e.selection.anchor, e.selection.head) : p35.single(0);
...
`;
    ...
    wordAt(e) {
        ...
        return r == o ? null : p35.range(r + n, o + n);
    }
};
...
function Ks(n, t, e, i, s, r, o, l) {
    ...
    for(let c = n; c;)if (c.nodeType == 1) {
        ...
        if (s == "nearest") t.top < f.top ? (g = -(f.top - t.top + o), e > 0 && t.bottom > f.bottom + g && (g = t.bottom - f.bottom + g + o)) : t.bottom > f.bottom && (g = t.bottom - f.bottom + o, e < 0 && t.top - g < f.top && (g = -(f.top + g - t.top + o)));
            ...
            let p = t.bottom - t.top, y = f.bottom - f.top;
            g = (s == "center" && p <= y ? t.top + p / 2 - y / 2 : s == "start" || s == "center" && e < 0 ? t.top - o : t.bottom - y + o) - f.top;
        }
        if (i == "nearest" ? t.left < f.left ? (u = -(f.left - t.left + r), e > 0 && t.right > f.right + u && (u = t.right - f.right + u + r)) : t.right > f.right && (u = t.right - f.right + r, e < 0 && t.left < f.left + u && (u = -(f.left + u - t.left + r))) : u = (i == "center" ? t.left + (t.right - t.left) / 2 - (f.right - f.left) / 2 : i == "start" == l ? t.left - r : t.right - (f.right - f.left) + r) - f.left, u || g) if (d) a.scrollBy(u, g);
            ...
            if (u) {
                let p = c.scrollLeft;
                c.scrollLeft += u, u = c.scrollLeft - p;
            }
            t = {
                left: t.left - u,
                top: t.top - g,
...
var $e;
function wt(n, t, e = t) {
    let i = $e || ($e = document.createRange());
...
var E2 = class {
    ...
    static before(t, e) {
        return new E2(t.parentNode, Xt(t), e);
    }
    static after(t, e) {
        return new E2(t.parentNode, Xt(t) + 1, e);
    }
}, Jt = [], M2 = class {
    constructor(){
...
function Xe(n, t, e, i, s, r) {
    ...
    n.length += f, _e(n, a, c, l, h, i, 0, s, r);
}
var [W1, Qt] = typeof navigator != "undefined" ? [
    navigator,
    document
] : [
    {
...
], te1 = /Edge\/(\d+)/.exec(W1.userAgent), Je = /MSIE \d/.test(W1.userAgent), ee1 = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(W1.userAgent), Wt = !!(Je || ee1 || te1), Ze = !Wt && /gecko\/(\d+)/i.test(W1.userAgent), ie1 = !Wt && /Chrome\/(\d+)/.exec(W1.userAgent), Qe = "webkitFontSmoothing" in Qt.documentElement.style, ti = !Wt && /Apple Computer/.test(W1.vendor), ei = ti && (/Mobile\/\w+/.test(W1.userAgent) || W1.maxTouchPoints > 2), m2 = {
    mac: ei || /Mac/.test(W1.platform),
    windows: /Win/.test(W1.platform),
    linux: /Linux|X11/.test(W1.platform),
    ie: Wt,
    ie_version: Je ? Qt.documentMode || 6 : ee1 ? +ee1[1] : te1 ? +te1[1] : 0,
    gecko: Ze,
    gecko_version: Ze ? +(/Firefox\/(\d+)/.exec(W1.userAgent) || [
        0,
        0
    ])[1] : 0,
    chrome: !!ie1,
    ...
    ios: ei,
    android: /Android\b/.test(W1.userAgent),
    webkit: Qe,
    safari: ti,
    ...
    merge(t, e, i) {
        return i && (!(i instanceof J2) || this.length - (e - t) + i.length > Gs) ? !1 : (this.text = this.text.slice(0, t) + (i ? i.text : "") + this.text.slice(e), this.markDirty(), !0);
    }
    split(t) {
    ...
    setAttrs(t) {
        if (Ye(t), this.mark.class && (t.className = this.mark.class), this.mark.attrs) for(let e in this.mark.attrs)t.setAttribute(e, this.mark.attrs[e]);
        return t;
    }
    reuseDOM(t) {
    ...
    merge(t, e, i, s, r, o) {
        return i && (!(i instanceof Z && i.mark.eq(this.mark)) || t && r <= 0 || e < this.length && o <= 0) ? !1 : (Xe(this, t, e, i ? i.children : [], r - 1, o - 1), this.markDirty(), !0);
    }
    split(t) {
        let e = [], i = 0, s = -1, r = 0;
...
function ii(n, t, e) {
    ...
    t > i && (t = i);
    let s = t, r = t, o = 0;
    t == 0 && e < 0 || t == i && e >= 0 ? m2.chrome || m2.gecko || (t ? (s--, o = 1) : (r++, o = -1)) : e < 0 ? s-- : r++;
    let l = wt(n, s, r).getClientRects();
    if (!l.length) return Ke;
    let h = l[(o ? o < 0 : e >= 0) ? 0 : l.length - 1];
    return m2.safari && !o && h.width == 0 && (h = Array.prototype.find.call(l, (a)=>a.width
    ) || h), o ? Ft(h, o < 0) : h || null;
}
var j2 = class extends M2 {
    ...
    domAtPos(t) {
        return t == 0 ? E2.before(this.dom) : E2.after(this.dom, t == this.length);
    }
    domBoundsAround() {
        return null;
    }
    coordsAt(t, e) {
        ...
        return t == 0 && e > 0 || t == this.length && e <= 0 ? s : Ft(s, t == 0);
    }
    get isEditable() {
        return !1;
    }
    ...
    domAtPos(t) {
        return new E2(this.widget.text, t);
    }
    sync() {
...
}, se1 = m2.android ? "\u200B\u200B" : "\u200B", rt = class extends M2 {
    constructor(t){
        super();
        this.side = t;
    }
...
function ni(n, t, e) {
    ...
    for(; i > 0; i--){
        let s = t[i - 1].dom;
        if (s.parentNode == n) return E2.after(s);
    }
    return new E2(n, 0);
}
function ri(n, t, e) {
...
var tt = class extends x3 {
    constructor(t, e, i, s, r, o){
        super(e, i, r, t);
        this.block = s, this.isReplace = o, this.mapMode = s ? e <= 0 ? D2.TrackBefore : D2.TrackAfter : D2.TrackDel;
    }
    get type() {
        return this.startSide < this.endSide ? v7.WidgetRange : this.startSide <= 0 ? v7.WidgetBefore : v7.WidgetAfter;
    }
    get heightRelevant() {
        return this.block || !!this.widget && this.widget.estimatedHeight >= 5;
    }
    eq(t) {
        return t instanceof tt && $s(this.widget, t.widget) && this.block == t.block && this.startSide == t.startSide && this.endSide == t.endSide;
    }
    range(t, e = t) {
...
var P3 = class extends M2 {
    ...
    merge(t, e, i, s, r, o) {
        if (i) {
            if (!(i instanceof P3)) return !1;
            this.dom || i.transferDOM(this);
        }
        return s && this.setDeco(i ? i.attrs : null), Xe(this, t, e, i ? i.children : [], r, o), !0;
    }
    split(t) {
        let e = new P3;
    ...
    posCovered() {
        ...
        return !t.breakAfter && !(t instanceof et && t.type == v7.WidgetBefore);
    }
    getLine() {
        return this.curLine || (this.content.push(this.curLine = new P3), this.atCursorPos = !0), this.curLine;
    }
    flushBuffer(t) {
    ...
    buildText(t, e, i) {
        for(; t > 0;){
            ...
            this.flushBuffer(e.slice(0, i)), this.getLine().append(It(new J2(this.text.slice(this.textOff, this.textOff + s)), e), i), this.atCursorPos = !0, this.textOff += s, t -= s, i = 0;
        }
    }
    span(t, e, i, s) {
    ...
    point(t, e, i, s, r) {
        ...
        if (i instanceof tt) if (i.block) {
            let { type: l  } = i;
            l == v7.WidgetAfter && !this.posCovered() && this.getLine(), this.addBlockWidget(new et(i.widget || new he1("div"), o, l));
        } else {
...
}, Ys = [], hi = O1.define(), ai = O1.define(), ci = O1.define(), fi = O1.define(), ae1 = O1.define(), ui = O1.define(), ce1 = v3.define({
    map: (n, t)=>n.map(t)
}), di = v3.define({
    map: (n, t)=>n.map(t)
}), ot = class {
...
var Us = 0, vt = O1.define(), z3 = class {
    constructor(t, e, i){
    ...
    static define(t, e) {
        ...
        )), r && o.push(V1.decorations.from(r)), new z3(Us++, t, o);
    }
...
function Zs(n) {
    return n <= 247 ? Xs[n] : 1424 <= n && n <= 1524 ? 2 : 1536 <= n && n <= 1785 ? Js[n - 1536] : 1774 <= n && n <= 2220 ? 4 : 8192 <= n && n <= 8203 || n == 8204 ? 256 : 1;
}
var Qs = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/, at = class {
    constructor(t, e, i){
...
function wi(n, t) {
    ...
    if (!n || i == 1 && !Qs.test(n)) return Si(e);
    for(let o = 0, l = i, h = i; o < e; o++){
        let a = Zs(n.charCodeAt(o));
...
function Ai(n, t, e, i, s) {
    ...
    if (xi = n.text.slice(Math.min(o, c), Math.max(o, c)), c != h.side(s, e)) return p35.cursor(c + n.from, a ? -1 : 1, h.level);
    let f = l == (s ? t.length - 1 : 0) ? null : t[l + (s ? 1 : -1)];
    return !f && h.level != e ? p35.cursor(s ? n.to : n.from, s ? -1 : 1, e) : f && f.level < h.level ? p35.cursor(f.side(!s, e) + n.from, s ? 1 : -1, f.level) : p35.cursor(c + n.from, s ? -1 : 1, h.level);
}
var pe1 = class {
    constructor(t, e){
    ...
    readTextNode(t) {
        var e, i2;
        let s = t.nodeValue;
        return /^\u200b/.test(s) && ((e = t.previousSibling) === null || e === void 0 ? void 0 : e.contentEditable) == "false" && (s = s.slice(1)), /\u200b$/.test(s) && ((i2 = t.nextSibling) === null || i2 === void 0 ? void 0 : i2.contentEditable) == "false" && (s = s.slice(0, s.length - 1)), s;
    }
    readNode(t) {
        if (t.cmIgnore) return;
        let e = M2.get(t), i = e && e.overrideDOMText, s;
        i != null ? s = i.sliceString(0, void 0, this.lineBreak) : t.nodeType == 3 ? s = this.readTextNode(t) : t.nodeName == "BR" ? s = t.nextSibling ? this.lineBreak : "" : t.nodeType == 1 && this.readRange(t.firstChild, null), s != null && (this.findPointIn(t, s.length), this.text += s, m2.chrome && this.view.inputState.lastKeyCode == 13 && !t.nextSibling && /\n\n$/.test(this.text) && (this.text = this.text.slice(0, -1)));
    }
    findPointBefore(t, e) {
...
var me1 = class {
    ...
    constructor(t){
        super();
        this.view = t, this.compositionDeco = x3.none, this.decorations = [], this.pluginDecorationLength = 0, this.minWidth = 0, this.minWidthFrom = 0, this.minWidthTo = 0, this.impreciseAnchor = null, this.impreciseHead = null, this.forceSelection = !1, this.lastUpdate = Date.now(), this.setDOM(t.contentDOM), this.children = [
            new P3
    ...
    update(t) {
        ...
        ) ? (this.minWidthFrom = t.changes.mapPos(this.minWidthFrom, 1), this.minWidthTo = t.changes.mapPos(this.minWidthTo, 1)) : this.minWidth = this.minWidthFrom = this.minWidthTo = 0), this.view.inputState.composing < 0 ? this.compositionDeco = x3.none : (t.transactions.length || this.dirty) && (this.compositionDeco = en(this.view, t.changes)), (m2.ie || m2.chrome) && !this.compositionDeco.size && t && t.state.doc.lines != t.startState.doc.lines && (this.forceSelection = !0);
        let i = this.decorations, s = this.updateDeco(), r = nn(i, s, t.changes);
    ...
    updateChildren(t, e) {
        ...
        for(let s = t.length - 1;; s--){
            let r = s >= 0 ? t[s] : null;
            if (!r) break;
            let { fromA: o , toA: l , fromB: h , toB: a  } = r, { content: c , breakAtStart: f , openStart: d , openEnd: u  } = zt.build(this.view.state.doc, h, a, this.decorations, this.pluginDecorationLength), { i: g , off: p  } = i.findPos(l, 1), { i: y , off: b  } = i.findPos(o, -1);
            _e(this, y, b, g, p, c, f, d, u);
        }
    }
    updateSelection(t = !1, e = !1) {
        if (t && this.view.observer.readSelectionRange(), !(e || this.mayControlSelection()) || m2.ios && this.view.inputState.rapidCompositionStart) return;
        ...
        (i || !l.focusNode || !Ht(r.node, r.offset, l.anchorNode, l.anchorOffset) || !Ht(o.node, o.offset, l.focusNode, l.focusOffset)) && (this.view.observer.ignore(()=>{
            m2.android && m2.chrome && this.dom.contains(l.focusNode) && rn(l.focusNode, this.dom) && (this.dom.blur(), this.dom.focus({
                preventScroll: !0
            }));
            let h = Nt(this.root);
            if (s.empty) {
                if (m2.gecko) {
                    let a = sn(r.node, r.offset);
                    if (a && a != (1 | 2)) {
                        let c = Di(r.node, r.offset, a == 1 ? 1 : -1);
                        c && (r = new E2(c, a == 1 ? 0 : c.nodeValue.length));
                    }
                }
        ...
        }), this.view.observer.setSelectionRange(r, o)), this.impreciseAnchor = r.precise ? null : new E2(l.anchorNode, l.anchorOffset), this.impreciseHead = o.precise ? null : new E2(l.focusNode, l.focusOffset);
    }
    enforceCursorAssoc() {
        if (this.compositionDeco.size) return;
        let t = this.view.state.selection.main, e = Nt(this.root);
        if (!t.empty || !t.assoc || !e.modify) return;
        let i = P3.find(this, t.head);
        if (!i) return;
        let s = i.posAtStart;
    ...
    mayControlSelection() {
        return this.view.state.facet(At) ? this.root.activeElement == this.dom : _t(this.dom, this.view.observer.selectionRange);
    }
    nearest(t) {
        for(let e = t; e;){
            let i = M2.get(e);
    ...
    domAtPos(t) {
        ...
        for(; e < this.children.length - 1;){
            ...
            if (i < s.length || s instanceof P3) break;
            e++, i = 0;
        }
    ...
    coordsAt(t, e) {
        for(let i = this.length, s = this.children.length - 1;; s--){
            ...
            if (t > o || t == o && r.type != v7.WidgetBefore && r.type != v7.WidgetAfter && (!s || e == 2 || this.children[s - 1].breakAfter || this.children[s - 1].type == v7.WidgetBefore && e > -2)) return r.coordsAt(t - o, e);
            i = o;
        }
    }
        ...
        for(let l = 0, h = 0; h < this.children.length; h++){
            ...
            if (l >= e) {
                ...
                if (t.push(f.height), r) {
                    ...
                    if (u.length) {
                        let g = u[u.length - 1], p = this.view.textDirection == N2.LTR ? g.right - f.left : f.right - g.left;
                        p > o && (o = p, this.minWidth = s, this.minWidthFrom = l, this.minWidthTo = c);
                    }
                }
            }
            l = c + a.breakAfter;
    ...
    measureTextSize() {
        for (let s of this.children)if (s instanceof P3) {
    ...
    scrollIntoView(t) {
        ...
        Ks(this.view.scrollDOM, a, e.head < e.anchor ? -1 : 1, t.x, t.y, t.xMargin, t.yMargin, this.view.textDirection == N2.LTR);
    }
};
function tn(n) {
...
function Mi(n) {
    let t = n.observer.selectionRange, e = t.focusNode && Di(t.focusNode, t.focusOffset, 0);
    if (!e) return null;
    ...
    if (i instanceof P3) {
        ...
        for(; r && !M2.get(r);)r = r.previousSibling;
        let o = r ? M2.get(r).posAtEnd : i.posAtStart;
        return {
            from: o,
            to: o,
            node: s,
...
function en(n, t) {
    let e = Mi(n);
    if (!e) return x3.none;
    let { from: i , to: s , node: r , text: o  } = e, l = t.mapPos(i, 1), h = Math.max(l, t.mapPos(s, -1)), { state: a  } = n, c = r.nodeType == 3 ? r.nodeValue : new pe1([], n).readRange(r.firstChild, null).text;
    if (h - l < c.length) if (a.sliceDoc(l, Math.min(a.doc.length, l + c.length)) == c) h = l + c.length;
    else if (a.sliceDoc(Math.max(0, h - c.length), h) == c) l = h - c.length;
    else return x3.none;
    else if (a.sliceDoc(l, h) != c) return x3.none;
    return x3.set(x3.replace({
        widget: new Ci(r, o)
    }).range(l, h));
}
var Ci = class extends Q1 {
    constructor(t, e){
        super();
...
function on(n, t, e = 1) {
    ...
    if (s.length == 0) return p35.cursor(t);
    ...
    return p35.range(o + s.from, l + s.from);
}
function ln(n, t) {
...
function Se1(n, t, e) {
    ...
    for(let u = n.firstChild; u; u = u.nextSibling){
        ...
        for(let p = 0; p < g.length; p++){
            let y = g[p];
            s && we1(s, y) && (y = Oi(Ti(y, s.bottom), s.top));
            let b = ln(t, y), O = hn(e, y);
            if (b == 0 && O == 0) return u.nodeType == 3 ? Ri(u, t, e) : Se1(u, t, e);
            (!i || o > O || o == O && r > b) && (i = u, s = y, r = b, o = O), b == 0 ? e > y.bottom && (!a || a.bottom < y.bottom) ? (l = u, a = y) : e < y.top && (!c || c.top > y.top) && (h = u, c = y) : a && we1(a, y) ? a = Ti(a, y.bottom) : c && we1(c, y) && (c = Oi(c, y.top));
        }
    }
    ...
    if (i.nodeType == 3) return Ri(i, f, e);
    ...
    for(let l = 0; l < i; l++){
        ...
        for(let a = 0; a < h.length; a++){
            ...
            if (c.left - 1 <= t && c.right + 1 >= t && f < r) {
                ...
                if ((m2.chrome || m2.gecko) && wt(n, l).getBoundingClientRect().left == c.right && (u = !d), f <= 0) return {
                    node: n,
                    offset: l + (u ? 1 : 0)
                };
                s = l + (u ? 1 : 0), r = f;
...
function Li(n, { x: t , y: e  }, i, s = -1) {
    ...
    for(let b = n.defaultLineHeight / 2, O = !1; h = n.elementAtHeight(c), h.type != v7.Text;)for(; c = s > 0 ? h.bottom + b : h.top - b, !(c >= 0 && c <= a);){
        if (O) return i ? null : 0;
        O = !0, s = -s;
    }
    e = l + c;
    let f = h.from;
    if (f < n.viewport.from) return n.viewport.from == 0 ? 0 : i ? null : Bi(n, o, h, t, e);
    if (f > n.viewport.to) return n.viewport.to == n.state.doc.length ? n.state.doc.length : i ? null : Bi(n, o, h, t, e);
    ...
    if (g && ((r1 = n.docView.nearest(g)) === null || r1 === void 0 ? void 0 : r1.isEditable) != !1) {
        if (d.caretPositionFromPoint) {
            let b = d.caretPositionFromPoint(t, e);
            b && ({ offsetNode: p , offset: y  } = b);
        } else if (d.caretRangeFromPoint) {
            let b = d.caretRangeFromPoint(t, e);
            b && ({ startContainer: p , startOffset: y  } = b, m2.safari && an(p, y, t) && (p = void 0));
        }
    }
    if (!p || !n.docView.dom.contains(p)) {
        let b = P3.find(n.docView, f);
        if (!b) return c > h.top + h.height / 2 ? h.to : h.from;
        ({ node: p , offset: y  } = Se1(b.dom, t, e));
    }
    return n.docView.posFromDOM(p, y);
}
function Bi(n, t, e, i, s) {
    ...
    return e.from + O15(o, r, n.state.tabSize);
}
function an(n, t, e) {
    let i;
...
function cn(n, t, e, i) {
    ...
    if (r) {
        let h = n.dom.getBoundingClientRect(), a = n.posAtCoords({
            x: e == (n.textDirection == N2.LTR) ? h.right - 1 : h.left + 1,
            y: (r.top + r.bottom) / 2
        });
        if (a != null) return p35.cursor(a, e ? -1 : 1);
    }
    let o = P3.find(n.docView, t.head), l = o ? e ? o.posAtEnd : o.posAtStart : e ? s.to : s.from;
    return p35.cursor(l, e ? -1 : 1);
}
function Ei(n, t, e, i) {
    ...
    for(let o = t, l = null;;){
        ...
        if (!h) {
            ...
            a = `
`, s = n.state.doc.line(s.number + (e ? 1 : -1)), r = n.bidiSpans(s), h = p35.cursor(e ? s.from : s.to);
        }
        if (l) {
            if (!l(a)) return o;
        } else {
...
function un(n, t, e, i) {
    ...
    if (s == (e ? n.state.doc.length : 0)) return p35.cursor(s, t.assoc);
    ...
    for(let u = 0;; u += 10){
        let g = l + (d + u) * r, p4 = Li(n, {
            x: f,
            y: g
        }, !1, r);
        if (g < h.top || g > h.bottom || (r < 0 ? p4 < s : p4 > s)) return p35.cursor(p4, t.assoc, void 0, o);
    }
}
function xe1(n, t, e) {
    ...
    for(;;){
        ...
        for (let r of i)r.between(e.from - 1, e.from + 1, (o, l, h)=>{
            e.from > o && e.from < l && (e = t.from > e.from ? p35.cursor(o, 1) : p35.cursor(l, -1), s = !0);
        });
        if (!s) return e;
    }
}
var Pi = class {
    constructor(t){
        ...
        for(let e in R5){
            ...
            t.contentDOM.addEventListener(e, (s)=>{
                e == "keydown" && this.keydown(t, s) || !Fi(t, s) || this.ignoreDuringComposition(s) || (this.mustFlushObserver(s) && t.observer.forceFlush(), this.runCustomHandlers(e, t, s) ? s.preventDefault() : i(t, s));
            }), this.registeredEvents.push(e);
        }
        this.notifiedFocused = t.hasFocus, this.ensureHandlers(t), m2.safari && t.contentDOM.addEventListener("input", ()=>null
        );
    }
    ...
    ensureHandlers(t) {
        ...
        for (let i of e)for(let s in i.handlers)this.registeredEvents.indexOf(s) < 0 && s != "scroll" && (this.registeredEvents.push(s), t.contentDOM.addEventListener(s, (r)=>{
            !Fi(t, r) || this.runCustomHandlers(s, t, r) && r.preventDefault();
        }));
    }
    ...
    keydown(t, e) {
        ...
        if (m2.android && m2.chrome && !e.synthetic && (e.keyCode == 13 || e.keyCode == 8)) return t.observer.delayAndroidKey(e.key, e.keyCode), !0;
        let i;
        return m2.ios && (i = Ni.find((s)=>s.keyCode == e.keyCode
    ...
    ignoreDuringComposition(t) {
        return /^key/.test(t.type) ? this.composing > 0 ? !0 : m2.safari && Date.now() - this.compositionEndedAt < 500 ? (this.compositionEndedAt = 0, !0) : !1 : !1;
    }
    screenKeyEvent(t, e) {
    ...
    mustFlushObserver(t) {
        return t.type == "keydown" && t.keyCode != 229 || t.type == "compositionend" && !m2.ios;
    }
    ...
    constructor(t, e, i, s){
        ...
        r.addEventListener("mousemove", this.move = this.move.bind(this)), r.addEventListener("mouseup", this.up = this.up.bind(this)), this.extend = e.shiftKey, this.multiple = t.state.facet(w1.allowMultipleSelections) && dn(t, e), this.dragMove = gn(t, e), this.dragging = pn(t, e) && Ae1(e) == 1 ? null : !1, this.dragging === !1 && (e.preventDefault(), this.select(e));
    }
    move(t) {
...
function dn(n, t) {
    ...
    return e.length ? e[0](t) : m2.mac ? t.metaKey : t.ctrlKey;
}
function gn(n, t) {
    let e = n.state.facet(ai);
    return e.length ? e[0](t) : m2.mac ? !t.altKey : !t.ctrlKey;
}
function pn(n, t) {
...
var R5 = Object.create(null), Wi = m2.ie && m2.ie_version < 15 || m2.ios && m2.webkit_version < 604;
function mn(n) {
    ...
    if (ve1 != null && e.selection.ranges.every((h)=>h.empty
        ...
        i = e.changeByRange((a)=>{
            ...
            return {
                ...
                range: p35.cursor(a.from + f.length)
            };
        });
        ...
        return {
            ...
            range: p35.cursor(h.from + a.length)
        };
...
var Ii = 0;
R5.touchstart = (n, t)=>{
    Ii = Date.now(), n.inputState.setSelectionOrigin("select.pointer");
};
R5.touchmove = (n)=>{
    n.inputState.setSelectionOrigin("select.pointer");
};
R5.mousedown = (n, t)=>{
    if (n.observer.flush(), Ii > Date.now() - 2000 && Ae1(t) == 1) return;
    let e = null;
    for (let i of n.state.facet(ci))if (e = i(n, t), e) break;
    if (!e && t.button == 0 && (e = wn(n, t)), e) {
        let i = n.root.activeElement != n.contentDOM;
        i && n.observer.ignore(()=>Ge(n.contentDOM)
        ), n.inputState.startMouseSelection(new Vi(n, t, e, i));
    }
};
function qi(n, t, e, i) {
    if (i == 1) return p35.cursor(t, e);
    if (i == 2) return on(n.state, t, e);
    {
        let s = P3.find(n.docView, t), r = n.state.doc.lineAt(s ? s.posAtEnd : t), o = s ? s.posAtStart : r.from, l = s ? s.posAtEnd : r.to;
        return l < n.state.doc.length && l == r.to && l++, p35.range(o, l);
    }
}
var Ki = (n, t)=>n >= t.top && n <= t.bottom
, ji = (n, t, e)=>Ki(t, e) && n >= e.left && n <= e.right
;
function bn(n, t, e, i) {
    let s = P3.find(n.docView, t);
    if (!s) return 1;
    let r = t - s.posAtStart;
    if (r == 0) return 1;
    if (r == s.length) return -1;
    let o = s.coordsAt(r, -1);
    if (o && ji(e, i, o)) return -1;
    let l = s.coordsAt(r, 1);
    return l && ji(e, i, l) ? 1 : o && Ki(i, o) ? -1 : 1;
}
function Gi(n, t) {
    let e = n.posAtCoords({
        x: t.clientX,
    ...
    return {
        pos: e,
        bias: bn(n, e, t.clientX, t.clientY)
    };
}
var yn = m2.ie && m2.ie_version <= 11, $i = null, Yi = 0, Ui = 0;
function Ae1(n) {
    if (!yn) return n.detail;
    let t = $i, e = Ui;
    return $i = n, Ui = Date.now(), Yi = !t || e > Date.now() - 400 && Math.abs(t.clientX - n.clientX) < 2 && Math.abs(t.clientY - n.clientY) < 2 ? (Yi + 1) % 3 : 1;
}
function wn(n, t) {
    let e = Gi(n, t), i = Ae1(t), s = n.state.selection, r = e, o = t;
    return {
        update (l) {
        ...
        get (l, h, a) {
            let c;
            if (o && l.clientX == o.clientX && l.clientY == o.clientY ? c = r : (c = r = Gi(n, l), o = l), !c || !e) return s;
            let f = qi(n, c.pos, c.bias, i);
            if (e.pos != c.pos && !h) {
                let d = qi(n, e.pos, e.bias, i), u = Math.min(d.from, f.from), g = Math.max(d.to, f.to);
                f = u < f.from ? p35.range(u, g) : p35.range(g, u);
            }
            return h ? s.replaceRange(s.main.extend(f.from, f.to)) : a ? s.addRange(f) : p35.create([
                f
            ]);
        }
    };
...
R5.drop = (n, t)=>{
    ...
    if (e && e.length) {
        ...
        let i = Array(e.length), s = 0, r = ()=>{
            ++s == e.length && _i(n, t, i.filter((o)=>o != null
    ...
    } else _i(n, t, t.dataTransfer.getData("Text"), !0);
};
R5.paste = (n, t)=>{
    if (n.state.readOnly) return t.preventDefault();
    n.observer.flush();
    let e = Wi ? null : t.clipboardData;
    e ? (zi(n, e.getData("text/plain")), t.preventDefault()) : mn(n);
};
function Sn(n, t) {
...
R5.copy = R5.cut = (n, t)=>{
    ...
    r ? (t.preventDefault(), r.clearData(), r.setData("text/plain", e)) : Sn(n, e), t.type == "cut" && !n.state.readOnly && n.dispatch({
        changes: i,
        scrollIntoView: !0,
...
R5.compositionstart = R5.compositionupdate = (n)=>{
...
R5.beforeinput = (n, t)=>{
    var e;
    let i;
    if (m2.chrome && m2.android && (i = Ni.find((s)=>s.inputType == t.inputType
...
var Ji = [
    ...
    constructor(){
        this.doc = d.empty, this.lineWrapping = !1, this.direction = N2.LTR, this.heightSamples = {
    ...
    mustRefreshForStyle(t, e) {
        return Ji.indexOf(t) > -1 != this.lineWrapping || this.direction != e;
    }
    ...
    refresh(t, e, i, s, r, o) {
        let l = Ji.indexOf(t) > -1, h = Math.round(i) != Math.round(this.lineHeight) || this.lineWrapping != l || this.direction != e;
    ...
    applyChanges(t, e, i, s) {
        ...
        for(let o = s.length - 1; o >= 0; o--){
            let { fromA: l , toA: h , fromB: a , toB: c  } = s[o], f = r.lineAt(l, A9.ByPosNoHeight, e, 0, 0), d = f.to >= h ? f : r.lineAt(h, A9.ByPosNoHeight, e, 0, 0);
            for(c += d.to - h, h = d.to; o > 0 && f.from <= s[o - 1].toA;)l = s[o - 1].fromA, a = s[o - 1].fromB, o--, l < f.from && (f = r.lineAt(l, A9.ByPosNoHeight, e, 0, 0));
            a += f.from - l, l = f.from;
    ...
    static of(t) {
        ...
        let o = 0;
        return t[e - 1] == null ? (o = 1, e--) : t[e] == null && (o = 1, i++), new Zi(H1.of(t.slice(0, e)), o, H1.of(t.slice(i)));
    }
};
H1.prototype.size = 1;
var De = class extends H1 {
    ...
    replace(t, e, i) {
        let s = i[0];
        return i.length == 1 && (s instanceof F2 || s instanceof L2 && s.flags & 4) && Math.abs(this.length - s.length) < 10 ? (s instanceof L2 ? s = new F2(s.length, this.height) : s.height = this.height, this.outdated || (s.outdated = !1), s) : H1.of(i);
    }
    updateHeight(t, e = 0, i = !1, s) {
    ...
    blockAt(t, e, i, s) {
        ...
        return new K1(a, c, i + l * h, l, v7.Text);
    }
    lineAt(t, e, i, s, r) {
        if (e == A9.ByHeight) return this.blockAt(t, i, s, r);
        if (e == A9.ByPosNoHeight) {
            let { from: f , to: d  } = i.lineAt(t);
            return new K1(f, d - f, 0, 0, v7.Text);
        }
        let { firstLine: o , lineHeight: l  } = this.lines(i, r), { from: h , length: a , number: c  } = i.lineAt(t);
        return new K1(h, a, s + l * (c - o), l, v7.Text);
    }
    forEachLine(t, e, i, s, r, o) {
        let { firstLine: l , lineHeight: h  } = this.lines(i, r);
        for(let a = Math.max(t, r), c = Math.min(r + this.length, e); a <= c;){
            let f = i.lineAt(a);
            a == t && (s += h * (f.number - l)), o(new K1(f.from, f.length, s, h, v7.Text)), s += h, a = f.to + 1;
        }
    }
    replace(t, e, i) {
        let s = this.length - e;
        if (s > 0) {
            let r = i[i.length - 1];
            r instanceof L2 ? i[i.length - 1] = new L2(r.length + s) : i.push(null, new L2(s - 1));
        }
        if (t > 0) {
            let r = i[0];
            r instanceof L2 ? i[0] = new L2(t + r.length) : i.unshift(new L2(t - 1), null);
        }
        return H1.of(i);
    }
    decomposeLeft(t, e) {
        e.push(new L2(t - 1), null);
    }
    decomposeRight(t, e) {
        e.push(null, new L2(this.length - t - 1));
    }
    updateHeight(t, e = 0, i = !1, s) {
        let r = e + this.length;
        if (s && s.from <= e + this.length && s.more) {
            let o = [], l = Math.max(e, s.from), h = -1, a = t.heightChanged;
            for(s.from > e && o.push(new L2(s.from - e - 1).updateHeight(t, e)); l <= r && s.more;){
            ...
            l <= r && o.push(null, new L2(r - l).updateHeight(t, l));
            let c = H1.of(o);
    ...
    lineAt(t, e, i, s, r) {
        let o = s + this.left.height, l = r + this.left.length + this.break, h = e == A9.ByHeight ? t < o : t < l, a = h ? this.left.lineAt(t, e, i, s, r) : this.right.lineAt(t, e, i, o, l);
        if (this.break || (h ? a.to < l : a.from > l)) return a;
        let c = e == A9.ByPosNoHeight ? A9.ByPosNoHeight : A9.ByPos;
    ...
    forEachLine(t, e, i, s, r, o) {
        ...
        if (this.break) t < h && this.left.forEachLine(t, e, i, s, r, o), e >= h && this.right.forEachLine(t, e, i, l, h, o);
            ...
            let a = this.lineAt(h, A9.ByPos, i, s, r);
    ...
    replace(t, e, i) {
        ...
        if (t > 0 && Qi(r, o - 1), e < this.length) {
            let l = r.length;
            this.decomposeRight(e, r), Qi(r, l);
        }
        return H1.of(r);
    }
    decomposeLeft(t, e) {
...
function Qi(n, t) {
    let e, i;
    n[t] == null && (e = n[t - 1]) instanceof L2 && (i = n[t + 1]) instanceof L2 && n.splice(t - 1, 3, new L2(e.length + 1 + i.length));
}
var An = 5, jt = class {
    constructor(t, e){
    ...
    span(t, e) {
        if (this.lineStart > -1) {
            ...
            s instanceof F2 ? s.length += i - this.pos : (i > this.pos || !this.isCovered) && this.nodes.push(new F2(i - this.pos, -1)), this.writtenTo = i, e > i && (this.nodes.push(null), this.writtenTo++, this.lineStart = -1);
        }
        this.pos = e;
    }
    point(t, e, i) {
        if (t < e || i.heightRelevant) {
            ...
            let r = e - t;
            i.block ? this.addBlock(new De(r, s, i.type)) : (r || s >= An) && this.addLineDeco(s, r);
    ...
    enterLine() {
        ...
        this.lineStart = t, this.lineEnd = e, this.writtenTo < t && ((this.writtenTo < t - 1 || this.nodes[this.nodes.length - 1] == null) && this.nodes.push(this.blankContent(this.writtenTo, t - 1)), this.nodes.push(null)), this.pos > t && this.nodes.push(new F2(this.pos - t, -1)), this.writtenTo = this.pos;
    }
    blankContent(t, e) {
        let i = new L2(e - t);
    ...
    ensureLine() {
        ...
        if (t instanceof F2) return t;
        let e = new F2(0, -1);
        return this.nodes.push(e), e;
    }
    addBlock(t) {
        this.enterLine(), t.type == v7.WidgetAfter && !this.isCovered && this.ensureLine(), this.nodes.push(t), this.writtenTo = this.pos = this.pos + t.length, t.type != v7.WidgetBefore && (this.covering = t);
    }
    addLineDeco(t, e) {
    ...
    finish(t) {
        ...
        this.lineStart > -1 && !(e instanceof F2) && !this.isCovered ? this.nodes.push(new F2(0, -1)) : (this.writtenTo < this.pos || e == null) && this.nodes.push(this.blankContent(this.writtenTo, this.pos));
        let i = t;
        for (let s of this.nodes)s instanceof F2 && s.updateHeight(this.oracle, i), i += s ? s.length : 1;
        return this.nodes;
    }
...
var Gt = class {
    ...
    constructor(t){
        this.state = t, this.pixelViewport = {
            ...
            top: 0,
            bottom: 0
        }, this.inView = !0, this.paddingTop = 0, this.paddingBottom = 0, this.contentDOMWidth = 0, this.contentDOMHeight = 0, this.editorHeight = 0, this.editorWidth = 0, this.heightOracle = new Me, this.scaler = ns, this.scrollTarget = null, this.printing = !1, this.mustMeasureContent = !0, this.visibleRanges = [], this.mustEnforceCursorAssoc = !1, this.heightMap = H1.empty().applyChanges(t.facet(ht), d.empty, this.heightOracle.setDoc(t.doc), [
            new I2(0, 0, 0, t.doc.length)
        ]), this.viewport = this.getViewport(0, null), this.updateViewportLines(), this.updateForViewport(), this.lineGaps = this.ensureLineGaps([]), this.lineGapDeco = x3.set(this.lineGaps.map((e)=>e.draw(!1)
    ...
    updateForViewport() {
        ...
        ), this.scaler = this.heightMap.height <= 7000000 ? ns : new rs(this.heightOracle.doc, this.heightMap, this.viewports);
    }
    updateViewportLines() {
    ...
    update(t, e = null) {
        let i = this.state;
        this.state = t.state;
        let s = this.state.facet(ht), r = t.changedRanges, o = I2.extendWithRanges(r, vn(t.startState.facet(ht), s, t ? t.changes : y1.empty(this.state.doc.length))), l = this.heightMap.height;
    ...
    measure(t) {
        let e = t.contentDOM, i = window.getComputedStyle(e), s = this.heightOracle, r = i.whiteSpace, o = i.direction == "rtl" ? N2.RTL : N2.LTR, l = this.heightOracle.mustRefreshForStyle(r, o), h = l || this.mustMeasureContent || this.contentDOMHeight != e.clientHeight, a = 0, c = 0;
        if (h) {
            this.mustMeasureContent = !1, this.contentDOMHeight = e.clientHeight;
            let b = parseInt(i.paddingTop) || 0, O = parseInt(i.paddingBottom) || 0;
            (this.paddingTop != b || this.paddingBottom != O) && (a |= 8, this.paddingTop = b, this.paddingBottom = O);
        }
        let f = this.printing ? {
            top: -100000000,
            bottom: 100000000,
            left: -100000000,
            right: 100000000
        } : Mn(e, this.paddingTop), d = f.top - this.pixelViewport.top, u = f.bottom - this.pixelViewport.bottom;
        ...
        let p = e.clientWidth;
        if ((this.contentDOMWidth != p || this.editorHeight != t.scrollDOM.clientHeight || this.editorWidth != t.scrollDOM.clientWidth) && (this.contentDOMWidth = p, this.editorHeight = t.scrollDOM.clientHeight, this.editorWidth = t.scrollDOM.clientWidth, a |= 8), h) {
            let b = t.docView.measureVisibleLineHeights();
            if (s.mustRefreshForHeights(b) && (l = !0), l || s.lineWrapping && Math.abs(p - this.contentDOMWidth) > s.charWidth) {
                let { lineHeight: O , charWidth: S  } = t.docView.measureTextSize();
                l = s.refresh(r, o, O, S, p / S, b), l && (t.docView.minWidth = 0, a |= 8);
            }
            d > 0 && u > 0 ? c = Math.max(d, u) : d < 0 && u < 0 && (c = Math.min(d, u)), s.heightChanged = !1, this.heightMap = this.heightMap.updateHeight(s, 0, l, new Ce(this.viewport.from, b)), s.heightChanged && (a |= 2);
        }
        ...
        return y && (this.viewport = this.getViewport(c, this.scrollTarget)), this.updateForViewport(), (a & 2 || y) && this.updateViewportLines(), (this.lineGaps.length || this.viewport.to - this.viewport.from > 4000) && this.updateLineGaps(this.ensureLineGaps(l ? [] : this.lineGaps)), a |= this.computeVisibleRanges(), this.mustEnforceCursorAssoc && (this.mustEnforceCursorAssoc = !1, t.docView.enforceCursorAssoc()), a;
    }
    get visibleTop() {
    ...
    getViewport(t, e) {
        let i = 0.5 - Math.max(-0.5, Math.min(0.5, t / 1000 / 2)), s = this.heightMap, r = this.state.doc, { visibleTop: o , visibleBottom: l  } = this, h = new Ct(s.lineAt(o - i * 1000, A9.ByHeight, r, 0, 0).from, s.lineAt(l + (1 - i) * 1000, A9.ByHeight, r, 0, 0).to);
        if (e) {
            let { head: a  } = e.range, c = this.editorHeight;
            if (a < h.from || a > h.to) {
                let f = s.lineAt(a, A9.ByPos, r, 0, 0), d;
                e.y == "center" ? d = (f.top + f.bottom) / 2 - c / 2 : e.y == "start" || e.y == "nearest" && a < h.from ? d = f.top : d = f.bottom - c, h = new Ct(s.lineAt(d - 1000 / 2, A9.ByHeight, r, 0, 0).from, s.lineAt(d + c + 1000 / 2, A9.ByHeight, r, 0, 0).to);
            }
        }
        return h;
    }
    mapViewport(t, e) {
        ...
        return new Ct(this.heightMap.lineAt(i, A9.ByPos, this.state.doc, 0, 0).from, this.heightMap.lineAt(s, A9.ByPos, this.state.doc, 0, 0).to);
    }
    viewportIsAppropriate({ from: t , to: e  }, i = 0) {
        if (!this.inView) return !0;
        let { top: s  } = this.heightMap.lineAt(t, A9.ByPos, this.state.doc, 0, 0), { bottom: r  } = this.heightMap.lineAt(e, A9.ByPos, this.state.doc, 0, 0), { visibleTop: o , visibleBottom: l  } = this;
    ...
    ensureLineGaps(t) {
        ...
        for (let i of this.viewportLines){
            ...
            h.from >= i.from && h.from <= i.to && ss(l, h.from - 10, h.from + 10), !h.empty && h.to >= i.from && h.to <= i.to && ss(l, h.to - 10, h.to + 10);
            for (let { from: a , to: c  } of l)c - a > 1000 && e.push(Dn(t, (f)=>f.from >= i.from && f.to <= i.to && Math.abs(f.from - a) < 1000 && Math.abs(f.to - c) < 1000
    ...
    updateLineGaps(t) {
        Gt.same(t, this.lineGaps) || (this.lineGaps = t, this.lineGapDeco = x3.set(t.map((e)=>e.draw(this.heightOracle.lineWrapping)
        )));
    }
    ...
    lineBlockAt(t) {
        ...
        ) || Dt(this.heightMap.lineAt(t, A9.ByPos, this.state.doc, 0, 0), this.scaler);
    }
    lineBlockAtHeight(t) {
        return Dt(this.heightMap.lineAt(this.scaler.fromDOM(t), A9.ByHeight, this.state.doc, 0, 0), this.scaler);
    }
    elementAtHeight(t) {
...
var ns = {
    ...
    constructor(t, e, i){
        ...
        this.viewports = i.map(({ from: l , to: h  })=>{
            let a = e.lineAt(l, A9.ByPos, t, 0, 0).top, c = e.lineAt(h, A9.ByPos, t, 0, 0).bottom;
            return s += c - a, {
                from: l,
                to: h,
                top: a,
...
}), Te = x1.newName(), ls = x1.newName(), hs = x1.newName(), as = {
    "&light": "." + ls,
    "&dark": "." + hs
};
function Re(n, t, e) {
...
var kn = Re("." + Te, {
...
}, Le = m2.ie && m2.ie_version <= 11, cs = class {
    constructor(t, e, i){
        this.view = t, this.onChange = e, this.onScrollChanged = i, this.active = !1, this.selectionRange = new je, this.selectionChanged = !1, this.delayedFlush = -1, this.resizeTimeout = -1, this.queue = [], this.delayedAndroidKey = null, this.scrollTargets = [], this.intersection = null, this.resize = null, this.intersecting = !1, this.gapIntersection = null, this.gaps = [], this.parentCheck = -1, this.dom = t.contentDOM, this.observer = new MutationObserver((s)=>{
            ...
            (m2.ie && m2.ie_version <= 11 || m2.ios && t.composing) && s.some((r)=>r.type == "childList" && r.removedNodes.length || r.type == "characterData" && r.oldValue.length > r.target.nodeValue.length
    ...
    onSelectionChange(t) {
        ...
        if (e.state.facet(At) ? e.root.activeElement != this.dom : !_t(e.dom, i)) return;
        let s = i.anchorNode && e.docView.nearest(i.anchorNode);
        s && s.ignoreEvent(t) || ((m2.ie && m2.ie_version <= 11 || m2.android && m2.chrome) && !e.state.selection.main.empty && i.focusNode && Ht(i.focusNode, i.focusOffset, i.anchorNode, i.anchorOffset) ? this.flushSoon() : this.flush(!1));
    }
    readSelectionRange() {
        let { root: t  } = this.view, e = Nt(t), i = m2.safari && t.nodeType == 11 && Is() == this.view.contentDOM && Tn(this.view) || e;
    ...
    start() {
        this.active || (this.observer.observe(this.dom, On), Le && this.dom.addEventListener("DOMCharacterDataModified", this.onCharData), this.active = !0);
    }
    stop() {
    ...
    flush(t = !0) {
        ...
        let { from: e , to: i , typeOver: s  } = this.processRecords(), r = this.selectionChanged && _t(this.dom, this.selectionRange);
        if (e < 0 && !r) return;
    ...
    readMutation(t) {
        ...
        if (e.markDirty(t.type == "attributes"), t.type == "attributes" && (e.dirty |= 4), t.type == "childList") {
            let i = fs(e, t.previousSibling || t.target.previousSibling, -1), s = fs(e, t.nextSibling || t.target.nextSibling, 1);
            return {
...
function Tn(n) {
    ...
    return Ht(l.node, l.offset, r, o) && ([i, s, r, o] = [
        r,
        o,
        i,
        s
...
function Rn(n, t, e, i) {
    ...
    if (t > -1) {
        ...
        let { from: h , to: a  } = l, c = n.docView.impreciseHead || n.docView.impreciseAnchor ? [] : Bn(n), f = new pe1(c, n);
        f.readRange(l.startDOM, l.endDOM), r = En(c, h);
        let d = o.from, u = null;
        (n.inputState.lastKeyCode === 8 && n.inputState.lastKeyTime > Date.now() - 100 || m2.android && f.text.length < a - h) && (d = o.to, u = "end");
        let g = Ln(n.state.sliceDoc(h, a), f.text, d - h, u);
        g && (s = {
            from: h + g.from,
            to: h + g.toA,
        ...
        (c != o.head || f != o.anchor) && (r = p35.single(f, c));
    }
    if (!(!s && !r)) {
        if (!s && i && !o.empty && r && r.main.empty ? s = {
            ...
            let l = n.state;
            if (m2.ios && n.inputState.flushIOSKey(n) || m2.android && (s.from == o.from && s.to == o.to && s.insert.length == 1 && s.insert.lines == 2 && St(n.contentDOM, "Enter", 13) || s.from == o.from - 1 && s.to == o.to && s.insert.length == 0 && St(n.contentDOM, "Backspace", 8) || s.from == o.from && s.to == o.to + 1 && s.insert.length == 0 && St(n.contentDOM, "Delete", 46))) return;
            ...
            if (s.from >= o.from && s.to <= o.to && s.to - s.from >= (o.to - o.from) / 3 && (!r || r.main.empty && r.main.from == s.from + s.insert.length) && n.inputState.composing < 0) {
                ...
                let f = l.changes(s), d = r && !l.selection.main.eq(r.main) && r.main.to <= f.newLength ? r.main : void 0;
                if (l.selection.ranges.length > 1 && n.inputState.composing >= 0 && s.to <= o.to && s.to >= o.to - 10) {
                    let u = n.state.sliceDoc(s.from, s.to), g = Mi(n) || n.state.doc.lineAt(o.head), p4 = o.to - s.to, y = o.to - o.from;
                    a = l.changeByRange((b)=>{
                        if (b.from == o.from && b.to == o.to) return {
                            changes: f,
                            range: d || b.map(f)
                        };
                        let O = b.to - p4, S = O - u.length;
                        if (b.to - b.from != y || n.state.sliceDoc(S, O) != u || g && b.to >= g.from && b.from <= g.to) return {
                            range: b
                        };
                        let D = l.changes({
                            from: S,
                        ...
                        return {
                            changes: D,
                            range: d ? p35.range(Math.max(0, d.anchor + T), Math.max(0, d.head + T)) : b.map(D)
                        };
                    });
                } else a = {
                    changes: f,
                    selection: d && l.selection.replaceRange(d)
                };
            }
            let c = "input.type";
...
function En(n, t) {
    ...
    return e > -1 && i > -1 ? p35.single(e + t, i + t) : null;
}
var k2 = class {
    constructor(t = {
    }){
        ...
        ), this.dispatch = this.dispatch.bind(this), this.root = t.root || js(t.parent) || document, this.viewState = new ke(t.state || w1.create()), this.plugins = this.state.facet(vt).map((e)=>new qt(e)
        );
        for (let e of this.plugins)e.update(this);
        this.observer = new cs(this, (e, i, s)=>{
            Rn(this, e, i, s);
        }, (e)=>{
            this.inputState.runScrollHandlers(this, e), this.observer.intersecting && this.measure();
        }), this.inputState = new Pi(this), this.docView = new be1(this), this.mountStyles(), this.updateAttrs(), this.updateState = 0, Nn(), this.requestMeasure(), t.parent && t.parent.appendChild(this.dom);
    }
    get state() {
        ...
        try {
            ...
            for (let o1 of t){
                if (r && (r = r.map(o1.changes)), o1.scrollIntoView) {
                    ...
                    r = new ot(l.empty ? l : p35.cursor(l.head, l.head > l.anchor ? -1 : 1));
                }
    ...
    setState(t) {
        ...
        try {
            ...
            this.viewState = new ke(t), this.plugins = t.facet(vt).map((i)=>new qt(i)
            ...
            for(let i = 0;; i++){
                ...
                let l = o.map((f)=>{
                    try {
                        ...
                        return lt(this.state, d), us;
                    }
                }), h = new ue1(this, this.state), a = !1, c = !1;
                ...
                for(let f = 0; f < o.length; f++)if (l[f] != us) try {
                    let d = o[f];
    ...
    get themeClasses() {
        return Te + " " + (this.state.facet(Oe1) ? hs : ls) + " " + this.state.facet(os);
    }
    updateAttrs() {
        let t = ds(this, bi, {
            ...
            class: "cm-content",
            style: `${m2.tabSize}: ${this.state.tabSize}`,
            role: "textbox",
            "aria-multiline": "true"
        };
        this.state.readOnly && (e["aria-readonly"] = "true"), ds(this, fe1, e), this.observer.ignore(()=>{
            oe1(this.contentDOM, this.contentAttrs, e), oe1(this.dom, this.editorAttrs, t);
        }), this.editorAttrs = t, this.contentAttrs = e;
    }
    showAnnouncements(t) {
        let e = !0;
        for (let i of t)for (let s of i.effects)if (s.is(k2.announce)) {
    ...
    mountStyles() {
        this.styleModules = this.state.facet(Mt), x1.mount(this.root, this.styleModules.concat(kn).reverse());
    }
    readMeasured() {
    ...
    moveByChar(t, e, i) {
        return xe1(this, t, Ei(this, t, e, i));
    }
    moveByGroup(t, e) {
        return xe1(this, t, Ei(this, t, e, (i)=>fn(this, t.head, i)
        ));
    }
    moveToLineBoundary(t, e, i = !0) {
        return cn(this, t, e, i);
    }
    moveVertically(t, e, i) {
        return xe1(this, t, un(this, t, e, i));
    }
    scrollPosIntoView(t) {
        this.dispatch({
            effects: ce1.of(p35.cursor(t))
        });
    }
    domAtPos(t) {
    ...
    posAtCoords(t, e = !0) {
        return this.readMeasured(), Li(this, t, e);
    }
    coordsAtPos(t, e = 1) {
        this.readMeasured();
    ...
    bidiSpans(t) {
        if (t.length > Pn) return Si(t.length);
    ...
    get hasFocus() {
        var t2;
        return (document.hasFocus() || m2.safari && ((t2 = this.inputState) === null || t2 === void 0 ? void 0 : t2.lastContextMenu) > Date.now() - 30000) && this.root.activeElement == this.contentDOM;
    }
    focus() {
    ...
    static scrollIntoView(t, e = {
        ...
        return gi.of(new ot(typeof t == "number" ? p35.cursor(t) : t, e.y, e.x, e.yMargin, e.xMargin));
    }
    ...
    static baseTheme(t) {
        return Ie.lowest(Mt.of(Re("." + Te, t, as)));
    }
};
k2.scrollTo = ce1;
k2.centerOn = di;
...
k2.inputHandler = ui;
k2.exceptionSink = fi;
k2.updateListener = ae1;
k2.editable = At;
k2.mouseSelectionStyle = ci;
k2.dragMovesSelection = ai;
k2.clickAddsSelectionRange = hi;
k2.decorations = ht;
k2.darkTheme = Oe1;
k2.contentAttributes = fe1;
k2.editorAttributes = bi;
k2.lineWrapping = k2.contentAttributes.of({
    class: "cm-lineWrapping"
});
k2.announce = v3.define();
var Pn = 4096;
function Be(n, t) {
...
var us = {
    ...
    static update(t, e) {
        if (e.empty) return t;
        let i = [], s = t.length ? t[t.length - 1].dir : N2.LTR;
...
var Vn = m2.mac ? "mac" : m2.windows ? "win" : m2.linux ? "linux" : "key";
function Fn(n, t) {
...
var Wn = k2.domEventHandlers({
    keydown (n, t) {
        return ms(ps(t.state), n, t, "editor");
    }
}), zn = O1.define({
    enables: Wn
}), gs = new WeakMap;
function ps(n) {
    let t = n.facet(zn), e = gs.get(t);
    return e || gs.set(t, e = qn(t.reduce((i, s)=>i.concat(s)
    , []))), e;
}
function hr(n, t, e) {
    return ms(ps(n.state), t, n, e);
}
var it = null, In = 4000;
function qn(n, t = Vn) {
    let e = Object.create(null), i = Object.create(null), s = (o, l)=>{
        ...
        let c = e[o] || (e[o] = Object.create(null)), f = l.split(/ (?!$)/).map((g)=>Fn(g, t)
        );
        for(let g = 1; g < f.length; g++){
            let p = f.slice(0, g).join(" ");
            s(p, !0), c[p] || (c[p] = {
                preventDefault: !0,
                commands: [
                    (y)=>{
...
var Ne = class {
    ...
    readPos() {
        let { state: n  } = this.view, t = n.facet(Ot), e = n.selection.ranges.map((s)=>s.empty ? [] : Gn(this.view, s)
        ).reduce((s, r)=>s.concat(r)
        ), i = [];
        for (let s of n.selection.ranges){
            let r = s == n.selection.main;
            if (s.empty ? !r || bs : t.drawRangeCursor) {
                let o = $n(this.view, s, r);
                o && i.push(o);
            }
        }
        return {
...
bs && (ys[".cm-line"].caretColor = "transparent !important");
var jn = Ie.highest(k2.theme(ys));
function ws(n) {
    let t = n.scrollDOM.getBoundingClientRect();
    return {
        left: (n.textDirection == N2.LTR ? t.left : t.right - n.scrollDOM.clientWidth) - n.scrollDOM.scrollLeft,
...
function xs(n, t) {
    ...
    if (Array.isArray(e.type)) {
        for (let i of e.type)if (i.to > t || i.to == t && (i.to == e.to || i.type == v7.Text)) return i;
    }
    return e;
}
function Gn(n, t) {
    if (t.to <= n.viewport.from || t.from >= n.viewport.to) return [];
    let e = Math.max(t.from, n.viewport.from), i = Math.min(t.to, n.viewport.to), s = n.textDirection == N2.LTR, r = n.contentDOM, o = r.getBoundingClientRect(), l = ws(n), h = window.getComputedStyle(r.firstChild), a = o.left + parseInt(h.paddingLeft) + Math.min(0, parseInt(h.textIndent)), c = o.right - parseInt(h.paddingRight), f = xs(n, e), d = xs(n, i), u = f.type == v7.Text ? f : null, g = d.type == v7.Text ? d : null;
    if (n.lineWrapping && (u && (u = Ss(n, e, u)), g && (g = Ss(n, i, g))), u && g && u.from == g.from) return y(b(t.from, t.to, u));
    {
        let S = u ? b(t.from, null, u) : O(f, !1), D = g ? b(null, t.to, g) : O(d, !0), T = [];
        return (u || f).to < (g || d).from - 1 ? T.push(p(a, S.bottom, c, D.top)) : S.bottom < D.top && n.elementAtHeight((S.bottom + D.top) / 2).type == v7.Text && (S.bottom = D.top = (S.bottom + D.top) / 2), y(S).concat(T).concat(y(D));
    }
    function p(S, D, T, G) {
        return new Ne(S - l.left, D - l.top - 0.01, T - S, G - D + 0.01, "cm-selectionBackground");
    }
    function y({ top: S , bottom: D , horizontal: T  }) {
        let G = [];
        for(let $ = 0; $ < T.length; $ += 2)G.push(p(T[$], S, T[$ + 1], D));
        return G;
    }
    function b(S, D, T) {
        let G = 1000000000, $ = -1000000000, Rt = [];
        function Fe(st, Y, ct, nt, pt) {
            let U = n.coordsAtPos(st, st == T.to ? -2 : 2), _ = n.coordsAtPos(ct, ct == T.from ? 2 : -2);
            G = Math.min(U.top, _.top, G), $ = Math.max(U.bottom, _.bottom, $), pt == N2.LTR ? Rt.push(s && Y ? a : U.left, s && nt ? c : _.right) : Rt.push(!s && nt ? a : _.left, !s && Y ? c : U.right);
        }
        let Lt = S ?? T.from, Bt = D ?? T.to;
        for (let st of n.visibleRanges)if (st.to > Lt && st.from < Bt) for(let Y = Math.max(st.from, Lt), ct = Math.min(st.to, Bt);;){
            let nt = n.state.doc.lineAt(Y);
            for (let pt of n.bidiSpans(nt)){
                let U = pt.from + nt.from, _ = pt.to + nt.from;
                if (U >= ct) break;
                _ > Y && Fe(Math.max(U, Y), S == null && U <= Lt, Math.min(_, ct), D == null && _ >= Bt, pt.dir);
            }
            if (Y = nt.to + 1, Y >= ct) break;
        }
        return Rt.length == 0 && Fe(Lt, S == null, Bt, D == null, n.textDirection), {
            top: G,
            bottom: $,
            horizontal: Rt
        };
...
function $n(n, t, e) {
    ...
    if (!i) return null;
    let s = ws(n);
    return new Ne(i.left - s.left, i.top - s.top, -1, i.bottom - i.top, e ? "cm-cursor cm-cursor-primary" : "cm-cursor cm-cursor-secondary");
}
var As = v3.define({
    map (n, t) {
    ...
    update (n, t) {
        return n != null && (n = t.changes.mapPos(n)), t.effects.reduce((e, i)=>i.is(As) ? i.value : e
        , n);
    }
...
var Ms = class {
    ...
    createDeco(t) {
        let e = new x2;
        for (let { from: i , to: s  } of Un(t, this.maxLength))vs(t.state.doc, this.regexp, i, s, (r, o, l)=>e.add(r, o, this.getDeco(l, t, r))
        );
        return e.finish();
    }
    updateDeco(t, e) {
    ...
    updateRange(t, e, i, s) {
        for (let r of t.visibleRanges){
            ...
            if (l > o) {
                ...
                else vs(t.state.doc, this.regexp, c, f, (g, p, y)=>d.push(this.getDeco(y, t, g).range(g, p))
                );
                e = e.update({
                    filterFrom: c,
                    filterTo: f,
...
}, He = /x/.unicode != null ? "gu" : "g", _n = new RegExp(`[\0-\
-\x7f-\x9f\0xAD\u061C\u200B\u200E\u200F\u2028\u2029\u202D\u202E\uFEFF\uFFF9-\uFFFC]`, He), Xn = {
    0: "null",
    7: "bell",
    8: "backspace",
...
var Yt = O1.define({
    combine (n) {
        ...
        return (t.replaceTabs = !Jn()) && (t.specialChars = new RegExp("	|" + t.specialChars.source, He)), t.addSpecialChars && (t.specialChars = new RegExp(t.specialChars.source + "|" + t.addSpecialChars.source, He)), t;
    }
});
function fr(n = {
}) {
...
var Cs = null;
function Zn() {
    return Cs || (Cs = z3.fromClass(class {
        constructor(n){
            this.view = n, this.decorations = x3.none, this.decorationCache = Object.create(null), this.decorator = this.makeDecorator(n.state.facet(Yt)), this.decorations = this.decorator.createDeco(n);
        }
        makeDecorator(n) {
            return new Ms({
                ...
                decoration: (t, e, i)=>{
                    ...
                    if (r == 9) {
                        ...
                        return x3.replace({
                            widget: new ks((l - h % l) * this.view.defaultCharacterWidth)
                        });
                    }
                    return this.decorationCache[r] || (this.decorationCache[r] = x3.replace({
                        widget: new Ds(n, r)
                    }));
                },
        ...
        update(n) {
            let t = n.state.facet(Yt);
            n.startState.facet(Yt) != t ? (this.decorator = this.makeDecorator(t), this.decorations = this.decorator.createDeco(n.view)) : this.decorations = this.decorator.updateDeco(n, this.decorations);
        }
    }, {
...
var Qn = "\u2022";
function tr(n) {
    return n >= 32 ? Qn : n == 10 ? "\u2424" : String.fromCharCode(9216 + n);
}
var Ds = class extends Q1 {
    constructor(t, e){
        super();
    ...
    toDOM(t) {
        let e = tr(this.code), i = t.state.phrase("Control character") + " " + (Xn[this.code] || "0x" + this.code.toString(16)), s = this.options.render && this.options.render(this.code, i, e);
        if (s) return s;
...
var er = x3.line({
    ...
    getDeco(n) {
        ...
        for (let i of n.state.selection.ranges){
            if (!i.empty) return x3.none;
            let s = n.lineBlockAt(i.head);
            s.from > t && (e.push(er.range(s.from)), t = s.from);
        }
        return x3.set(e);
    }
}, {
...
var g6 = B1.define({
    ...
    update (t, e) {
        ...
        if (n) {
            let u = e.docChanged ? p35.single(x16(e.changes)) : void 0, p4 = c1.fromTransaction(e, u), d = n.side, h = d == 0 ? t.undone : t.done;
            return p4 ? h = S6(h, h.length, s.minDepth, p4) : h = E11(h, e.startState.selection), new f3(d == 0 ? n.rest : h, d == 0 ? h : n.rest);
        }
...
function _1(t = {
    ...
    return [
        ...
        k2.domEventHandlers({
            beforeinput (e, s) {
                let n = e.inputType == "historyUndo" ? N3 : e.inputType == "historyRedo" ? M8 : null;
...
var N3 = m17(0, !1), M8 = m17(1, !1), z6 = m17(0, !0), I5 = m17(1, !0);
function T2(t) {
    return function(e) {
        let s = e.field(g6, !1);
        if (!s) return 0;
...
var H7 = T2(0), j4 = T2(1), c1 = class {
    ...
    static fromJSON(e) {
        return new c1(e.changes && y1.fromJSON(e.changes), [], e.mapped && I.fromJSON(e.mapped), e.startSelection && p35.fromJSON(e.startSelection), e.selectionsAfter.map(p35.fromJSON));
    }
...
function E11(t, e) {
    if (t.length) {
        let s = t[t.length - 1], n = s.selectionsAfter.slice(Math.max(0, s.selectionsAfter.length - P11));
...
function W2(t, e, s) {
    ...
    return new c1(o, v3.mapEffects(t.effects, e), r, t.startSelection.map(i), n);
}
var X1 = /^(input\.type|delete)($|\.)/, f3 = class {
    ...
    addSelection(e, s, n, o) {
        ...
        return i.length > 0 && s - this.prevTime < o && n == this.prevUserEvent && n && /^select($|\.)/.test(n) && K8(i[i.length - 1], e) ? this : new f3(E11(this.done, e), this.undone, s, n);
    }
    addMapping(e) {
        return new f3(D3(this.done, e), D3(this.undone, e), this.prevTime, this.prevUserEvent);
    }
    pop(e, s, n) {
        ...
        if (i.changes) {
            ...
            return i.mapped && (r = D3(r, i.mapped)), s.update({
                changes: i.changes,
...
var Z1 = class {
...
}, K9 = new WeakMap, oe2 = new WeakMap, P12 = class {
    ...
    balance(e = {
        ...
        return this.children.length <= 8 ? this : te2(B4.none, this.children, this.positions, 0, this.children.length, 0, this.length, (t, r, i)=>new P12(this.type, t, r, i, this.propValues)
        , e.makeTree || ((t, r, i)=>new P12(B4.none, t, r, i)
        ));
    }
    static build(e) {
        return Ce1(e);
...
function J9(h, e, t, r) {
    for(var i2; h.from == h.to || (t < 1 ? h.from >= e : h.from > e) || (t > -1 ? h.to <= e : h.to < e);){
        let n = !r && h instanceof T3 && h.index < 0 ? null : h.parent;
        if (!n) return h;
        h = n;
    }
    if (r) for(let n = h, s = n.parent; s; n = s, s = n.parent)n instanceof T3 && n.index < 0 && ((i2 = s.enter(e, t, !0)) === null || i2 === void 0 ? void 0 : i2.from) != n.from && (h = s);
    for(;;){
        let n = h.enter(e, t, r);
        if (!n) return h;
        h = n;
...
var T3 = class {
            ...
            for(let { children: l , positions: o  } = s.node, u = t > 0 ? l.length : -1; e != u; e += t){
                ...
                if (!!fe3(i, r, d, d + f.length)) {
                    if (f instanceof U1) {
                        ...
                        if (p > -1) return new O2(new ae4(s, f, e, d), null, p);
                    } else if (n & 1 || !f.type.isAnonymous || ee2(f)) {
                        let p;
                        if (!(n & 1) && f.props && (p = f.prop(y10.mounted)) && !p.overlay) return new T3(p.tree, d, e, s);
                        let v = new T3(f, d, e, s);
    ...
    enter(e, t, r = !0, i = !0) {
        ...
        if (r && (n = this.node.prop(y10.mounted)) && n.overlay) {
            let s = e - this.from;
            for (let { from: l , to: o  } of n.overlay)if ((t > 0 ? l <= s : l < s) && (t < 0 ? o >= s : o > s)) return new T3(n.tree, n.overlay[0].from + this.from, -1, this);
        }
...
var ae4 = class {
    ...
    child(e, t, r) {
        ...
        return n < 0 ? null : new O2(this.context, this, n);
    }
    get firstChild() {
    ...
    enter(e, t, r, i = !0) {
        ...
        return s < 0 ? null : new O2(this.context, this, s);
    }
    get parent() {
    ...
    get nextSibling() {
        ...
        return t < (this._parent ? e.buffer[this._parent.index + 3] : e.buffer.length) ? new O2(this.context, this._parent, t) : this.externalSibling(1);
    }
    get prevSibling() {
        let { buffer: e  } = this.context, t = this._parent ? this._parent.index + 4 : 0;
        return this.index == t ? this.externalSibling(-1) : new O2(this.context, this._parent, e.findChild(t, this.index, -1, 0, 4));
    }
    get cursor() {
        return new G1(this);
    }
    ...
    toTree() {
        ...
        return new P12(this.type, e, t, this.to - this.from);
    }
    resolve(e, t = 0) {
        return J9(this, e, t, !1);
    }
    ...
    constructor(e, t = 0){
        if (this.mode = t, this.buffer = null, this.stack = [], this.index = 0, this.bufferNode = null, e instanceof T3) this.yieldNode(e);
        else {
    ...
    yield(e) {
        return e ? e instanceof T3 ? (this.buffer = null, this.yieldNode(e)) : (this.buffer = e.context, this.yieldBuf(e.index, e.type)) : !1;
    }
    toString() {
    ...
    get node() {
        ...
        for(let i = r; i < this.stack.length; i++)t = new O2(this.buffer, t, this.stack[i]);
        return this.bufferNode = new O2(this.buffer, t, this.index);
    }
    get tree() {
...
function Ce1(h) {
    ...
    return new P12(o[h.topID], z.reverse(), F.reverse(), A);
}
var pe3 = new WeakMap;
function Y1(h, e) {
...
var $4 = class {
    ...
    startParse(e, t, r) {
        return typeof e == "string" && (e = new de4(e)), r = r ? r.length ? r.map((i)=>new N4(i.from, i.to)
        ) : [
            new N4(0, 0)
        ] : [
            new N4(0, e.length)
...
var re2 = class {
    ...
    advance() {
        ...
        if (this.innerDone == this.inner.length) {
            let r = this.baseTree;
            return this.stoppedAt != null && (r = new P12(r.type, r.children, r.positions, r.length, r.propValues.concat([
                [
                    ie2,
                    this.stoppedAt
                ]
    ...
    startInner() {
        let e = new be3(this.fragments), t = null, r = null, i = new G1(new T3(this.baseTree, this.ranges[0].from, 0, null), 1);
        e: for(let n, s; this.stoppedAt == null || i.from < this.stoppedAt;){
            ...
            if (e.hasNode(i)) {
                ...
                if (typeof n.overlay == "function") t = new ce4(n.parser, n.overlay, u, this.inner.length, i.from, i.tree, t);
                    ...
                    f.length && this.inner.push(new re2(n.parser, n.parser.startParse(this.input, ye2(u, f), f), n.overlay ? n.overlay.map((d)=>new N4(d.from - i.from, d.to - i.from)
            ...
            } else t && (o = t.predicate(i)) && (o === !0 && (o = new N4(i.from, i.to)), o.from < o.to && t.ranges.push(o));
            if (l && i.firstChild()) t && t.depth++, r && r.depth++;
            else for(; !i.nextSibling();){
                if (!i.parent()) break e;
                if (t && !--t.depth) {
                    let u = xe2(this.ranges, t.ranges);
                    u.length && this.inner.splice(t.index, 0, new re2(t.parser, t.parser.startParse(this.input, ye2(t.mounts, u), u), t.ranges.map((f)=>new N4(f.from - t.start, f.to - t.start)
                    ), t.target, u)), t = t.prev;
                }
                r && !--r.depth && (r = r.prev);
            }
...
function _e1(h) {
    ...
    function o(u, f, d, p, v) {
        ...
        return S.push(A ? e.toTree() : o(c + 4, l[c + 3], s.set.types[l[c]], z, F - z)), j.push(z - p), me3(s, l[c + 3], f, S, j, p), new P12(d, S, j, v);
    }
...
var ne2 = class {
    ...
    hasNode(e) {
        if (this.moveTo(e.from), !this.done && this.cursor.from + this.offset == e.from && this.cursor.tree) for(let t = this.cursor.tree;;){
            ...
            if (t.children.length && t.positions[0] == 0 && t.children[0] instanceof P12) t = t.children[0];
            else break;
        }
        return !1;
    }
...
function xe2(h, e) {
    ...
    for(let i = 1, n = 0; i < h.length; i++){
        ...
        for(; n < r.length; n++){
            let o = r[n];
            if (o.from >= l) break;
            o.to <= s || (t || (r = t = e.slice()), o.from < s ? (t[n] = new N4(o.from, s), o.to > l && t.splice(n + 1, 0, new N4(l, o.to))) : o.to > l ? t[n--] = new N4(l, o.to) : t.splice(n--, 1));
        }
    }
    return r;
}
...
function ye2(h, e) {
    ...
    for (let { pos: r , mount: i , frag: n  } of h){
        ...
        if (i.overlay) {
            let f = i.overlay.map((p)=>new N4(p.from + r, p.to + r)
            ), d = Pe1(e, f, o, u);
            for(let p = 0, v = o;; p++){
    ...
    findRegions(t) {
        ...
        let i = [], r = (s, o)=>{
            ...
            for(let l = 0; l < s.children.length; l++){
                let h = s.children[l];
                h instanceof P12 && r(h, s.positions[l] + o);
            }
        };
        return r(v8(t), 0), i;
    }
...
u.setState = v3.define();
function B10(n, t, e) {
    let i = n.facet(m18);
    if (!i) return null;
    let r = i.data;
    if (i.allowsNesting) for(let s = v8(n).topNode; s; s = s.enter(t, e, !0, !1))r = s.type.prop(S7) || r;
    return r;
}
var P17 = class extends u {
    constructor(t, e){
        super(t, e, e.topNode);
        this.parser = e;
    }
    static define(t) {
        ...
        return new P17(e, t.parser.configure({
            props: [
    ...
    configure(t) {
        return new P17(this.data, this.parser.configure(t));
    }
    get allowsNesting() {
...
var D4 = class {
    ...
    work(t, e) {
        return e != null && e >= this.state.doc.length && (e = void 0), this.tree != P12.empty && this.isDone(e ?? this.state.doc.length) ? (this.takeTree(), !0) : this.withContext(()=>{
            var i;
            let r = Date.now() + t;
    ...
    withoutTempSkipped(t) {
        for(let e; e = this.tempSkipped.pop();)t = O5(t, e.from, e.to);
        return t;
    }
    changes(t, e) {
        ...
        if (this.takeTree(), !t.empty) {
            ...
            ), i = $4.applyChanges(i, l), r = P12.empty, s = 0, o = {
    ...
    updateViewport(t) {
        ...
        for(let i = 0; i < this.skipped.length; i++){
            ...
            r < t.to && s > t.from && (this.fragments = O5(this.fragments, r, s), this.skipped.splice(i--, 1));
        }
            ...
            createParse(e, i, r) {
                ...
                return {
                    ...
                    advance () {
                        ...
                        return this.parsedPos = o, new P12(B4.none, [], [], o - s);
                    },
                    stoppedAt: null,
                    stopAt () {
                    }
...
var c6 = class {
    ...
    static init(t) {
        let e = Math.min(3000, t.doc.length), i = new C5(t.facet(m18).parser, t, [], P12.empty, 0, {
            from: 0,
            to: e
        }, [], null);
...
u.state = B1.define({
    ...
    update (n, t) {
        ...
        return t.startState.facet(m18) != t.state.facet(m18) ? c6.init(t.state) : n.apply(t);
    }
});
var F8 = (n)=>{
    let t = setTimeout(()=>n()
...
typeof requestIdleCallback != "undefined" && (F8 = (n)=>{
...
var N5 = z3.fromClass(class {
    ...
    scheduleWork() {
        ...
        (e.tree != e.context.tree || !e.context.isDone(t.doc.length)) && (this.working = F8(this.work));
    }
    work(t) {
        this.working = null;
        let e = Date.now();
    ...
    static of(t) {
        ...
        return new T6(t.name, (t.alias || []).concat(t.name).map((r)=>r.toLowerCase()
...
function Q5(n, t) {
    let e = "", i = n.tabSize;
    if (n.facet(E12).charCodeAt(0) == 9) for(; t >= i;)e += "	", t -= i;
    for(let r = 0; r < t; r++)e += " ";
    return e;
}
function X4(n, t) {
...
function Z2(n, t, e) {
    return L5(t.resolveInner(e).enterUnfinishedNodesBefore(e), e, n);
}
function _2(n) {
...
var W3 = class extends I6 {
    ...
    continue() {
        ...
        return t ? L5(t, this.pos, this.base) : 0;
    }
};
function nt(n, t) {
...
function K13(t) {
    return [
        C7(),
        p4.of(Object.assign(Object.assign({
        }, V8), t))
    ];
}
var q5 = k2.baseTheme({
...
function C7(t) {
    ...
    return t && t.fixed === !1 && e.push(v9.of(!0)), e;
}
var P23 = z3.fromClass(class {
    constructor(t){
        this.view = t, this.prevViewport = t.viewport, this.dom = document.createElement("div"), this.dom.className = "cm-gutters", this.dom.setAttribute("aria-hidden", "true"), this.dom.style.minHeight = this.view.contentHeight + "px", this.gutters = t.state.facet(p4).map((e)=>new b6(t, e)
        );
        for (let e of this.gutters)this.dom.appendChild(e.dom);
        this.fixed = !t.state.facet(v9), this.fixed && (this.dom.style.position = "sticky"), this.syncGutters(!1), t.scrollDOM.insertBefore(this.dom, t.contentDOM);
    }
    update(t) {
        ...
        t.geometryChanged && (this.dom.style.minHeight = this.view.contentHeight + "px"), this.view.state.facet(v9) != !this.fixed && (this.fixed = !this.fixed, this.dom.style.position = this.fixed ? "sticky" : ""), this.prevViewport = t.view.viewport;
    }
    syncGutters(t) {
        let e = this.dom.nextSibling;
        t && this.dom.remove();
        let r = f10.iter(this.view.state.facet(k4), this.view.viewport.from), s = [], i = this.gutters.map((o)=>new O6(o, this.view.viewport, -this.view.documentPadding.top)
        );
        for (let o of this.view.viewportLineBlocks){
            let n;
            if (Array.isArray(o.type)) {
                for (let l of o.type)if (l.type == v7.Text) {
                    n = l;
                    break;
                }
            } else n = o.type == v7.Text ? o : void 0;
            if (!!n) {
                s.length && (s = []), E15(r, s, o.from);
    ...
    updateGutters(t) {
        let e = t.startState.facet(p4), r = t.state.facet(p4), s = t.docChanged || t.heightChanged || t.viewportChanged || !f10.eq(t.startState.facet(k4), t.state.facet(k4), t.view.viewport.from, t.view.viewport.to);
    ...
    provide: V1.scrollMargins.from((t)=>t.gutters.length == 0 || !t.fixed ? null : t.view.textDirection == N2.LTR ? {
...
var O6 = class {
    ...
    line(e, r, s) {
        this.localMarkers.length && (this.localMarkers = []), E15(this.cursor, this.localMarkers, r.from);
...
var j5 = p4.compute([
    d2
        ...
        renderEmptyElements: !1,
        markers (e) {
            return e.state.facet(R6);
        },
        lineMarker (e, r, s) {
            return s.some((i)=>i.toDOM
            ) ? null : new x17(w9(e, e.state.doc.lineAt(r.from).number));
        },
        lineMarkerChange: (e)=>e.startState.facet(d2) != e.state.facet(d2)
        ,
        initialSpacer (e) {
            return new x17(w9(e, N6(e.state.doc.lines)));
        },
        updateSpacer (e, r) {
            let s = w9(r.view, N6(r.view.state.doc.lines));
            return s == e.number ? e : new x17(s);
        },
...
var a12 = B1.define({
    ...
    provide: (e)=>k2.decorations.from(e)
});
function m19(e, t, o) {
    var n;
    let l = null;
...
function M10(e, t) {
    return e.field(a12, !1) ? t : t.concat(v3.appendConfig.of(O7()));
}
var U6 = (e)=>{
    for (let t of A11(e)){
    ...
    let t = [];
    for (let o of A11(e)){
        let n = m19(e.state, o.from, o.to);
        n && t.push(c9.of(n), D5(e, n, !1));
    }
...
function D5(e, t, o = !0) {
    ...
    return k2.announce.of(`${e.state.phrase(o ? "Folded lines" : "Unfolded lines")} ${n} ${e.state.phrase("to")} ${l}.`);
}
var L6 = (e)=>{
    let { state: t  } = e, o = [];
...
var _3 = x3.replace({
    widget: new class extends Q1 {
        ...
        toDOM(e) {
            let { state: t  } = e, o = t.facet(T7), n = (r)=>{
                let f = e.lineBlockAt(e.posAtDOM(r.target)), s = m19(e.state, f.from, f.to);
                s && e.dispatch({
                    effects: c9.of(s)
                }), r.preventDefault();
            };
...
function Y4(e = {
    ...
    }, q7), e), o = new p11(t, !0), n = new p11(t, !1), l = z3.fromClass(class {
        constructor(r){
            this.from = r.viewport.from, this.markers = this.buildMarkers(r);
        }
        update(r) {
            (r.docChanged || r.viewportChanged || r.startState.facet(m18) != r.state.facet(m18) || r.startState.field(a12, !1) != r.state.field(a12, !1)) && (this.markers = this.buildMarkers(r.view));
        }
        buildMarkers(r) {
            let f = new x2;
            for (let s of r.viewportLineBlocks){
                let i = m19(r.state, s.from, s.to) ? n : xt1(r.state, s.from, s.to) ? o : null;
...
function d8(a, t, e, r = {
    ...
    let o = r.maxScanDistance || D6, c = r.brackets || C8, i = v8(a), l = i.resolveInner(t, e);
    for(let f = l; f; f = f.parent){
        let n = x22(f.type, e, c);
        if (n && f.from < f.to) return A12(a, t, e, f, n, c);
    }
    return E16(a, t, e, i, l.type, o, c);
}
function A12(a, t, e, r, o, c) {
    ...
    if (n && (e < 0 ? n.childBefore(r.from) : n.childAfter(r.to))) do if (e < 0 ? n.to <= r.from : n.from >= r.to) {
        ...
        if (x22(n.type, e, c)) f++;
        else if (x22(n.type, -e, c) && (f--, f == 0)) return {
            start: l,
...
function g8(e, t) {
    return p35.create(e.ranges.map(t), e.mainIndex);
}
function m20(e, t) {
    return e.update({
        selection: t,
...
function y25({ state: e , dispatch: t  }, r) {
    ...
    return n.eq(e.selection) ? !1 : (t(m20(e, n)), !0);
}
function B12(e, t) {
    return p35.cursor(t ? e.to : e.from);
}
function C11(e, t) {
    return y25(e, (r)=>r.empty ? e.moveByChar(r, t) : B12(r, t)
    );
}
var _5 = (e)=>C11(e, e.textDirection != N2.LTR)
, $9 = (e)=>C11(e, e.textDirection == N2.LTR)
;
function D7(e, t) {
    return y25(e, (r)=>r.empty ? e.moveByGroup(r, t) : B12(r, t)
    );
}
var Ie1 = (e)=>D7(e, e.textDirection != N2.LTR)
, Te1 = (e)=>D7(e, e.textDirection == N2.LTR)
;
function Pe2(e, t, r) {
...
function S14(e, t, r) {
    let n = v8(e).resolveInner(t.head), l = r ? y10.closedBy : y10.openedBy;
    for(let i = t.head;;){
    ...
    return o && (c = r ? d8(e, n.from, 1) : d8(e, n.to, -1)) && c.matched ? u = r ? c.end.to : c.end.from : u = r ? n.to : n.from, p35.cursor(u, r ? -1 : 1);
}
var Ve1 = (e)=>y25(e, (t)=>S14(e.state, t, e.textDirection != N2.LTR)
    )
, Ge1 = (e)=>y25(e, (t)=>S14(e.state, t, e.textDirection == N2.LTR)
    )
;
function X6(e, t) {
    return y25(e, (r)=>{
...
function ee3(e, t) {
    ...
    return e.dispatch(m20(r, n), {
        effects: l && l.top > o.top && l.bottom < o.bottom ? k2.scrollIntoView(n.main.head, {
            y: "start",
            yMargin: l.top - o.top
        }) : void 0
    }), !0;
...
function b7(e, t, r) {
    ...
    if (l.head == t.head && l.head != (r ? n.to : n.from) && (l = e.moveToLineBoundary(t, r, !1)), !r && l.head == n.from && n.length) {
        ...
        o && t.head != n.from + o && (l = p35.cursor(n.from + o));
    }
    return l;
}
...
, Ue1 = (e)=>y25(e, (t)=>p35.cursor(e.lineBlockAt(t.head).from, 1)
    )
, Oe4 = (e)=>y25(e, (t)=>p35.cursor(e.lineBlockAt(t.head).to, -1)
    )
;
function ne4(e, t, r) {
    let n = !1, l = g8(e.selection, (o)=>{
        ...
        return r ? p35.range(o.anchor, u) : p35.cursor(u);
    });
    return n ? (t(m20(e, l)), !0) : !1;
}
...
function h2(e, t) {
    let r = g8(e.state.selection, (n)=>{
        let l = t(n);
        return p35.range(n.anchor, l.head, l.goalColumn);
    });
    return r.eq(e.state.selection) ? !1 : (e.dispatch(m20(e.state, r)), !0);
}
function M11(e, t) {
    return h2(e, (r)=>e.moveByChar(r, t)
    );
}
var oe4 = (e)=>M11(e, e.textDirection != N2.LTR)
, le2 = (e)=>M11(e, e.textDirection == N2.LTR)
;
function R7(e, t) {
    return h2(e, (r)=>e.moveByGroup(r, t)
    );
}
var we4 = (e)=>R7(e, e.textDirection != N2.LTR)
, ze = (e)=>R7(e, e.textDirection == N2.LTR)
;
var ve3 = (e)=>h2(e, (t)=>S14(e.state, t, e.textDirection != N2.LTR)
    )
, He1 = (e)=>h2(e, (t)=>S14(e.state, t, e.textDirection == N2.LTR)
    )
;
function ue5(e, t) {
...
, Ne2 = (e)=>h2(e, (t)=>p35.cursor(e.lineBlockAt(t.head).from)
    )
, We = (e)=>h2(e, (t)=>p35.cursor(e.lineBlockAt(t.head).to)
    )
, ye3 = ({ state: e , dispatch: t  })=>(t(m20(e, {
        anchor: 0
    })), !0)
, pe5 = ({ state: e , dispatch: t  })=>(t(m20(e, {
        anchor: e.doc.length
    })), !0)
, ke3 = ({ state: e , dispatch: t  })=>(t(m20(e, {
        anchor: e.selection.main.anchor,
        head: 0
    })), !0)
, ge5 = ({ state: e , dispatch: t  })=>(t(m20(e, {
        anchor: e.selection.main.anchor,
        head: e.doc.length
    })), !0)
...
, Ke1 = ({ state: e , dispatch: t  })=>{
    let r = T10(e).map(({ from: n , to: l  })=>p35.range(n, Math.min(l + 1, e.doc.length))
    );
    return t(e.update({
        selection: p35.create(r),
        userEvent: "select"
    })), !0;
}, je1 = ({ state: e , dispatch: t  })=>{
    let r = g8(e.selection, (n)=>{
        var l;
        let o = v8(e).resolveInner(n.head, 1);
        for(; !(o.from < n.from && o.to >= n.to || o.to > n.to && o.from <= n.from || !((l = o.parent) === null || l === void 0 ? void 0 : l.parent));)o = o.parent;
        return p35.range(o.to, o.from);
    });
    return t(m20(e, r)), !0;
}, _e2 = ({ state: e , dispatch: t  })=>{
    let r = e.selection, n = null;
    return r.ranges.length > 1 ? n = p35.create([
        r.main
    ]) : r.main.empty || (n = p35.create([
        p35.cursor(r.main.head)
    ])), n ? (t(m20(e, n)), !0) : !1;
};
function E17({ state: e , dispatch: t  }, r) {
...
function I7(e, t, r) {
    if (e instanceof k2) for (let n of e.pluginField(V1.atomicRanges))n.between(t, t, (l, o)=>{
        l < t && o > t && (t = r ? o : l);
    });
    return t;
}
...
function De1(e, t, r) {
    ...
    for (let o of T10(e)){
        ...
        if (r) {
            ...
            for (let i of o.ranges)l.push(p35.range(Math.min(e.doc.length, i.anchor + u), Math.min(e.doc.length, i.head + u)));
        } else {
            n.push({
                from: c.from,
                to: o.from
            ...
            for (let i of o.ranges)l.push(p35.range(i.anchor - u, i.head - u));
        }
    }
    return n.length ? (t(e.update({
        changes: n,
        scrollIntoView: !0,
        selection: p35.create(l, e.selection.mainIndex),
        userEvent: "move.line"
    })), !0) : !1;
}
...
, rt2 = (e)=>{
    ...
    let { state: t  } = e, r = t.changes(T10(t).map(({ from: l , to: o  })=>(l > 0 ? l-- : o < t.doc.length && o++, {
            from: l,
            to: o
        })
...
function nt1(e, t) {
    ...
    let r = v8(e).resolveInner(t), n = r.childBefore(t), l = r.childAfter(t), o;
...
function be9(e) {
    return ({ state: t , dispatch: r  })=>{
        ...
        let n = t.changeByRange((l)=>{
            ...
            return i && p13.push(Q5(t, f.lineIndent(u.from, -1))), {
                changes: {
                    from: o,
                    to: c,
                    insert: d.of(p13)
                },
                range: p35.cursor(o + 1 + p13[1].length)
            };
        });
        return r(t.update(n, {
            scrollIntoView: !0,
...
function z10(e, t) {
    ...
    return e.changeByRange((n)=>{
        ...
        return {
            changes: l,
            range: p35.range(o.mapPos(n.anchor, 1), o.mapPos(n.head, 1))
        };
    });
}
...
}, v10 = ({ state: e , dispatch: t  })=>e.readOnly ? !1 : (t(e.update(z10(e, (r, n)=>{
        n.push({
            from: r.from,
            insert: e.facet(E12)
        });
...
function M12(r, e) {
    ...
    for (let f of c){
        let l = C12(b(f, 0));
        if (e == f) return l == f ? H9(r, f, c.indexOf(f + f + f) > -1) : W7(r, f, l, n.before || d9.before);
        if (e == l && E18(r, r.selection.main.from)) return F15(r, f, l);
    }
    return null;
}
function E18(r, e) {
    let n = !1;
    return r.field(x23).between(0, r.doc.length, (c)=>{
        c == e && (n = !0);
    }), n;
}
function h3(r, e) {
...
function W7(r, e, n, c) {
    let f = null, l = r.changeByRange((t)=>{
        if (!t.empty) return {
            ...
            range: p35.range(t.anchor + e.length, t.head + e.length)
        };
        ...
        return !s || /\s/.test(s) || c.indexOf(s) > -1 ? {
            ...
            range: p35.cursor(t.head + e.length)
        } : {
            range: f = t
        };
    });
...
function F15(r, e, n) {
    let c = null, f = r.selection.ranges.map((l)=>l.empty && h3(r.doc, l.head) == n ? p35.cursor(l.head + n.length) : c = l
    );
    return c ? null : r.update({
        selection: p35.create(f, r.selection.mainIndex),
        scrollIntoView: !0,
...
function H9(r, e, n) {
    let c = null, f = r.changeByRange((l)=>{
        if (!l.empty) return {
            ...
            range: p35.range(l.anchor + e.length, l.head + e.length)
        };
        ...
        if (s == e) {
            if (I8(r, t)) return {
                ...
                range: p35.cursor(t + e.length)
            };
            if (E18(r, t)) {
                let o = n && r.sliceDoc(t, t + e.length * 3) == e + e + e;
                return {
                    range: p35.cursor(t + e.length * (o ? 3 : 1)),
                    effects: g9.of(t)
                };
            }
        } else {
...
var X7 = {
    ...
    static get(e, t, n) {
        ...
        if (!s || s.from >= n || s.to <= t) {
            ...
            return T12.set(e, l), l;
        }
        if (s.from == t && s.to == n) return s;
        let { text: i , from: a  } = s;
        return a > t && (i = e.sliceString(t, a) + i, a = t), s.to < n && (i += e.sliceString(s.to, n)), T12.set(e, new S17(a, i)), new S17(t, i.slice(t - a, n - a));
    }
}, W8 = class {
...
typeof Symbol != "undefined" && ($10.prototype[Symbol.iterator] = W8.prototype[Symbol.iterator] = function() {
    return this;
});
function de6(r) {
    try {
...
function V12(r) {
    ...
    function n() {
        ...
        r.dispatch({
            effects: L7.of(!1),
            selection: p35.cursor(B.from + Math.max(0, Math.min(m, B.length))),
            scrollIntoView: !0
        }), r.focus();
    }
    return {
...
var L7 = v3.define(), Y6 = B1.define({
    create () {
        return !0;
    },
    update (r, e) {
        for (let t of e.effects)t.is(L7) && (r = t.value);
        return r;
    },
    ...
    if (!e) {
        ...
        r.state.field(Y6, !1) == null && t.push(v3.appendConfig.of([
            Y6,
            pe6
        ])), r.dispatch({
            effects: t
...
var xe4 = x3.mark({
    ...
    getDeco(r) {
        ...
        if (n.ranges.length > 1) return x3.none;
        let s = n.main, i, a = null;
        if (s.empty) {
            if (!e.highlightWordAroundCursor) return x3.none;
            let c = t.wordAt(s.head);
            if (!c) return x3.none;
            a = t.charCategorizer(s.head), i = t.sliceDoc(c.from, c.to);
        } else {
            let c = s.to - s.from;
            if (c < e.minSelectionLength || c > 200) return x3.none;
            if (i = t.sliceDoc(s.from, s.to).trim(), !i) return x3.none;
        }
        let l = [];
        for (let c of r.visibleRanges){
            ...
            for(; !d.next().done;){
                ...
                if ((!a || (h == 0 || a(t.sliceDoc(h - 1, h)) != T.Word) && (m == t.doc.length || a(t.sliceDoc(m, m + 1)) != T.Word)) && (a && h <= s.from && m >= s.to ? l.push(be10.range(h, m)) : (h >= s.to || m <= s.from) && l.push(xe4.range(h, m)), l.length > e.maxMatches)) return x3.none;
            }
        }
        return x3.set(l);
    }
    ...
    let { selection: t  } = r, n = p35.create(t.ranges.map((s)=>r.wordAt(s.head) || p35.cursor(s.head)
    ), t.mainIndex);
...
var ve4 = ({ state: r , dispatch: e  })=>{
    ...
    let s = ke4(r, n);
    return s ? (e(r.update({
        selection: r.selection.addRange(p35.range(s.from, s.to), !1),
        scrollIntoView: !0
    })), !0) : !1;
}, P24 = O1.define({
    combine (r) {
...
}, M13 = v3.define(), Q7 = v3.define(), p19 = B1.define({
    create (r) {
        return new A14(R8(r).create(), E19);
    },
    update (r, e) {
        for (let t of e.effects)t.is(M13) ? r = new A14(t.value.create(), r.panel) : t.is(Q7) && (r = new A14(r.query, t.value ? E19 : null));
        return r;
    },
...
var A14 = class {
    ...
    constructor(r){
        this.view = r, this.decorations = this.highlight(r.state.field(p19));
    }
    update(r) {
        let e = r.state.field(p19);
        (e != r.startState.field(p19) || r.docChanged || r.selectionSet) && (this.decorations = this.highlight(e));
    }
    highlight({ query: r , panel: e  }) {
        if (!e || !r.spec.valid) return x3.none;
...
function k13(r) {
    return (e)=>{
        let t = e.state.field(p19, !1);
        return t && t.query.spec.valid ? r(e, t) : ne5(e);
    };
}
var F16 = k13((r, { query: e  })=>{
    ...
    return !t || !t.length ? !1 : (r.dispatch({
        selection: p35.create(t.map((n)=>p35.range(n.from, n.to)
        )),
    ...
    for(let l = new b9(r.doc, r.sliceDoc(n, s)); !l.next().done;){
        ...
        l.value.from == n && (a = i.length), i.push(p35.range(l.value.from, l.value.to));
    }
    return e(r.update({
        selection: p35.create(i, a),
        userEvent: "select.search.matches"
    })), !0;
}, re6 = k13((r, { query: e  })=>{
...
function E19(r) {
    return r.state.facet(P24).createPanel(r);
}
function R8(r, e) {
    var t13;
    let n = r.selection.main, s = n.empty || n.to > n.from + 100 ? "" : r.sliceDoc(n.from, n.to), i = (t13 = e == null ? void 0 : e.caseSensitive) !== null && t13 !== void 0 ? t13 : r.facet(P24).caseSensitive;
    return e && !s ? e : new N8({
        search: s.replace(/\n/g, "\\n"),
        caseSensitive: i
    });
...
var ne5 = (r)=>{
    ...
    if (e && e.panel) {
        ...
        effects: [
            Q7.of(!0),
            e ? M13.of(R8(r.state, e.query.spec)) : v3.appendConfig.of(Re1)
        ]
    });
    return !0;
}, se4 = (r)=>{
    ...
    constructor(e){
        this.view = e;
        let t = this.query = e.state.field(p19).query.spec;
    ...
    keydown(e) {
        hr(this.view, e, "search-panel") ? e.preventDefault() : e.keyCode == 13 && e.target == this.searchField ? (e.preventDefault(), (e.shiftKey ? D8 : F16)(this.view)) : e.keyCode == 13 && e.target == this.replaceField && (e.preventDefault(), re6(this.view));
    }
    update(e) {
    ...
    get top() {
        return this.view.state.facet(P24).top;
    }
};
function f7(r, e) {
...
function H10(r, { from: e , to: t  }) {
    ...
    return k2.announce.of(`${r.state.phrase("current match")}. ${l} ${r.state.phrase("on line")} ${r.state.doc.lineAt(e).number}`);
}
var Ee1 = k2.baseTheme({
    ".cm-panel.cm-search": {
        padding: "2px 6px 4px",
        position: "relative",
        "& [name=close]": {
        ...
        for(let r = 0; r < o.length; r++){
            ...
            if (!!l) {
                for(let n = 0; n < this.tooltips.length; n++){
                    ...
                    h && h.create == l.create && (a = n);
                }
                if (a < 0) s[r] = this.createTooltipView(l);
                else {
                    let n = s[r] = this.tooltipViews[a];
                    n.update && n.update(t);
                }
            }
        }
...
var T15 = O1.define({
    ...
    constructor(i){
        ...
        this.position = e.position, this.parent = e.parent, this.classes = i.themeClasses, this.createContainer(), this.measureReq = {
            ...
            key: this
        }, this.manager = new M17(i, k15, (o)=>this.createTooltip(o)
    ...
    update(i) {
        ...
        let e = t || i.geometryChanged, o = i.state.facet(T15);
    ...
    readMeasure() {
        ...
        return {
            ...
            space: this.view.state.facet(T15).tooltipSpace(this.view)
        };
    }
    writeMeasure(i) {
        let { editor: t , space: e  } = i, o = [];
        for(let s = 0; s < this.manager.tooltips.length; s++){
            let r = this.manager.tooltips[s], l = this.manager.tooltipViews[s], { dom: a  } = l, n = i.pos[s], h = i.size[s];
            ...
            let p = r.arrow ? l.dom.querySelector(".cm-tooltip-arrow") : null, d = p ? 7 : 0, g = h.right - h.left, b = h.bottom - h.top, m = l.offset || q13, V = this.view.textDirection == N2.LTR, u = h.width > e.right - e.left ? V ? e.left : e.right - h.width : V ? Math.min(n.left - (p ? 14 : 0) + m.x, e.right - g) : Math.max(e.left, n.left - g + (p ? 14 : 0) - m.x), c = !!r.above;
            ...
            if (l.overlap !== !0) for (let v of o)v.left < O && v.right > u && v.top < f + b && v.bottom > f && (f = c ? v.top - b - 2 - d : v.bottom + d + 2);
            this.position == "absolute" ? (a.style.top = f - i.parent.top + "px", a.style.left = u - i.parent.left + "px") : (a.style.top = f + "px", a.style.left = u + "px"), p && (p.style.left = `${n.left + (V ? m.x : -m.x) - (u + 14 - 7)}px`), l.overlap !== !0 && o.push({
                left: u,
                top: f,
                right: O,
                bottom: f + b
            }), a.classList.toggle("cm-tooltip-above", c), a.classList.toggle("cm-tooltip-below", !c), l.positioned && l.positioned();
        }
    }
    maybeMeasure() {
...
}), w14 = O1.define(), x32 = class {
    constructor(t){
        this.view = t, this.mounted = !1, this.dom = document.createElement("div"), this.dom.classList.add("cm-tooltip-hover"), this.manager = new M17(t, w14, (e)=>this.createHostedView(e)
        );
    }
    static create(t) {
        return new x32(t);
    ...
    startHover() {
        ...
        ), l = r && r.dir == N2.RTL ? -1 : 1, a = this.source(this.view, o, e.x < s.left ? -l : l);
        if ((t13 = a) === null || t13 === void 0 ? void 0 : t13.then) {
            let n = this.pending = {
                pos: o
            };
            a.then((h)=>{
    ...
    mousemove(t) {
        ...
        let o = this.active;
        if (o && !W9(this.lastMove.target) || this.pending) {
...
function j9(i, t, e, o, s, r) {
    let l = document.createRange(), a = i.domAtPos(t), n = i.domAtPos(e);
    l.setEnd(n.node, n.offset), l.setStart(a.node, a.offset);
    let h = l.getClientRects();
    l.detach();
...
function G6(i, t = {
    ...
    let e = v3.define(), o = B1.define({
        create () {
            return null;
        },
        update (r, l) {
            if (r && t.hideOnChange && (l.docChanged || l.selection)) return null;
            for (let a of l.effects){
                if (a.is(e)) return a.value;
                if (a.is(R9)) return null;
            }
            if (r && l.docChanged) {
                let a = l.changes.mapPos(r.pos, -1, D2.TrackDel);
                if (a == null) return null;
                let n = Object.assign(Object.create(null), r);
                return n.pos = a, r.end != null && (n.end = l.changes.mapPos(r.end)), n;
            }
            return r;
        },
        provide: (r)=>w14.from(r)
    }), s = t.hoverTime || 600;
    return [
        o,
        z3.define((r)=>new D9(r, i, o, e, s)
        ),
        N9
    ];
}
...
var R9 = v3.define(), Q9 = R9.of(null);
var _7 = class {
    constructor(e, t, i){
        this.state = e, this.pos = t, this.explicit = i, this.abortListeners = [];
    }
    tokenBefore(e) {
        let t = v8(this.state).resolveInner(this.pos, -1);
...
function xt2(n, e) {
    return (t)=>{
        for(let i = v8(t.state).resolveInner(t.pos, -1); i; i = i.parent)if (n.indexOf(i.name) > -1) return null;
        return e(t);
    };
}
var H13 = class {
...
var le3 = class {
    constructor(e, t){
        ...
        let i = e.state.field(t), { options: s , selected: o  } = i.open, l = e.state.facet(w15);
    ...
    updateSel() {
        ...
        if ((t.selected < this.range.from || t.selected >= this.range.to) && (this.range = oe5(t.options.length, t.selected, this.view.state.facet(w15).maxRenderedOptions), this.list.remove(), this.list = this.dom.appendChild(this.createListBox(t.options, e.id, this.range)), this.list.addEventListener("scroll", ()=>{
            this.info && this.view.requestMeasure(this.placeInfo);
    ...
    measureInfo() {
        ...
        let o = Math.max(0, Math.min(s.top, innerHeight - i.height)) - t.top, l = this.view.textDirection == N2.RTL, r = t.left, a = innerWidth - t.right;
...
var E20 = class {
    ...
    setSelected(e, t) {
        return e == this.selected || e >= this.options.length ? this : new E20(this.options, ae6(t, e), this.tooltip, this.timestamp, e);
    }
    ...
    map(e) {
        return new E20(this.options, this.attrs, Object.assign(Object.assign({
        }, this.tooltip), {
    ...
    update(e) {
        let { state: t  } = e, i = t.facet(w15), o = (i.override || t.languageDataAt("autocomplete", I10(t)).map($e2)).map((r)=>(this.active.find((c)=>c.source == r
        ...
        ) || !ze1(o, this.active) ? E20.build(o, t, this.id, this.open, i) : this.open && e.docChanged ? this.open.map(e.changes) : this.open;
...
var u2 = class {
    ...
    handleUserEvent(e, t, i) {
        ...
        return this.span && (s == o || this.span.test(e.state.sliceDoc(s, o))) ? new T18(this.source, r, this.result, s, o, this.span) : new u2(this.source, 1, r);
    }
    handleChange(e) {
        return e.changes.touchesRange(this.from, this.to) ? new u2(this.source, 0) : this.map(e.changes);
    }
    map(e) {
        return e.empty ? this : new T18(this.source, this.explicitPos < 0 ? -1 : e.mapPos(this.explicitPos), this.result, e.mapPos(this.from), e.mapPos(this.to, 1), this.span);
    }
}, z15 = v3.define(), Q10 = v3.define(), fe5 = v3.define({
    map (n, e) {
        return n.map((t)=>t.map(e)
        );
    }
}), pe7 = v3.define(), m21 = B1.define({
    create () {
        return S19.start();
    },
    update (n, e) {
    ...
    provide: (n)=>[
            k15.from(n, (e)=>e.tooltip
            ),
            k2.contentAttributes.from(n, (e)=>e.attrs
            )
        ]
}), he5 = 75;
function M18(n, e = "option") {
    return (t)=>{
        let i = t.state.field(m21, !1);
...
, Ge2 = (n)=>{
    ...
    constructor(n){
        ...
        for (let e of n.state.field(m21).active)e.state == 1 && this.startQuery(e);
    }
    update(n) {
        let e = n.state.field(m21);
        if (!n.selectionSet && !n.docChanged && n.startState.field(m21) == e) return;
    ...
    startUpdate() {
        ...
        let { state: n  } = this.view, e = n.field(m21);
    ...
    accept() {
        ...
        let e = [], t = this.view.state.facet(w15);
        for(let i = 0; i < this.running.length; i++){
            let s = this.running[i];
            if (s.done === void 0) continue;
            if (this.running.splice(i--, 1), s.done) {
                let l = new T18(s.active.source, s.active.explicitPos, s.done, s.done.from, (n = s.done.to) !== null && n !== void 0 ? n : I10(s.updates.length ? s.updates[0].startState : this.view.state), s.done.span && s.done.filter !== !1 ? te5(s.done.span, !0) : null);
            ...
            let o = this.view.state.field(m21).active.find((l)=>l.source == s.active.source
            );
    ...
    map(e) {
        return new O11(this.field, e.mapPos(this.from, -1), e.mapPos(this.to, 1));
    }
}, D10 = class {
    constructor(e, t){
    ...
    instantiate(e, t) {
        ...
        for (let a of this.lines){
            if (i.length) {
                ...
                for(let p = 0; p < f; p++)c += e.facet(E12);
                s.push(t + c.length - f), a = c + a.slice(f);
            }
            i.push(a), t += a.length + 1;
        }
        let r = this.fieldPositions.map((a)=>new O11(a.field, s[a.line] + a.from, s[a.line] + a.to)
        );
        return {
            text: i,
            ranges: r
    ...
    constructor(e, t){
        this.ranges = e, this.active = t, this.deco = x3.set(e.map((i)=>(i.from == i.to ? et3 : tt3).range(i.from, i.to)
        ));
    }
    map(e) {
...
}), it3 = v3.define(), P28 = B1.define({
    create () {
        return null;
    },
    update (n, e) {
        for (let t of e.effects){
            if (t.is(k18)) return t.value;
    ...
    provide: (n)=>k2.decorations.from(n, (e)=>e ? e.deco : x3.none
        )
});
function V13(n, e) {
    return p35.create(n.filter((t)=>t.field == e
    ).map((t)=>p35.range(t.from, t.to)
    ));
}
function nt2(n) {
    let e = D10.parse(n);
    return (t, i, s, o)=>{
        ...
        if (r.length && (a.selection = V13(r, 0)), r.length > 1) {
            ...
            t.state.field(P28, !1) === void 0 && f.push(v3.appendConfig.of([
                P28,
                at1,
                ct1,
                me6
...
function ve5(n) {
    return ({ state: e , dispatch: t  })=>{
        ...
        return t(e.update({
            ...
            effects: k18.of(o ? null : new b15(i.ranges, s))
        })), !0;
    };
}
var st1 = ({ state: n , dispatch: e  })=>n.field(P28, !1) ? (e(n.update({
        effects: k18.of(null)
    })), !0) : !1
...
var ct1 = k2.domEventHandlers({
    mousedown (n, e) {
        let t = e.state.field(P28, !1), i;
        ...
        return !s || s.field == t.active ? !1 : (e.dispatch({
            ...
            effects: k18.of(t.ranges.some((o)=>o.field > s.field
...
], ut2 = Ie.highest(zn.computeN([
    w15
], (n)=>n.facet(w15).defaultKeymap ? [
        ht1
    ] : []
));
var B15 = (c)=>{
    let m = x33(c.state);
    return m.line ? D11(c) : m.block ? C17(c) : !1;
};
function u6(c, m) {
...
var D11 = u6(y44, 0), v12 = u6(y44, 1), L9 = u6(y44, 2), C17 = u6(k41, 0), T20 = u6(k41, 1), I11 = u6(k41, 2), M19 = [
    {
        key: "Mod-/",
        run: B15
    },
...
function x33(c, m = c.selection.main.head) {
...
function b18(c, { open: m , close: i  }, n, r) {
    let e = c.sliceDoc(n - p21, n), t = c.sliceDoc(r, r + p21), s = /\s*$/.exec(e)[0].length, f = /^\s*/.exec(t)[0].length, l = e.length - s;
    ...
    let o, g;
    r - n <= 2 * p21 ? o = g = c.sliceDoc(n, r) : (o = c.sliceDoc(n, n + p21), g = c.sliceDoc(r - p21, r));
...
function k41(c, m, i) {
    let n = m.map((e)=>x33(i, e.from).block
    );
    if (!n.every((e)=>e
    )) return null;
    ...
    if (c != 2 && !r.every((e)=>e
        ...
        return i.changeByRange((t)=>{
            ...
            return {
                ...
                range: p35.range(t.anchor + l, t.head + l)
            };
        });
...
function M20(e, l, t) {
    ...
    if (l.off > s4 || t.off > s4 || l.col < 0 || t.col < 0) {
        ...
        for(let r = n; r <= o; r++){
            let c = e.doc.line(r);
            c.length <= a && f.push(p35.range(c.from + i, c.to + a));
        }
    } else {
        let i = Math.min(l.col, t.col), a = Math.max(l.col, t.col);
        for(let r = n; r <= o; r++){
            let c = e.doc.line(r), m = O15(c.text, i, e.tabSize, !0);
            if (m > -1) {
                let g = O15(c.text, a, e.tabSize);
                f.push(p35.range(c.from + m, c.from + g));
            }
        }
    }
    return f;
...
function p23(e, l) {
    ...
    return t ? {
        ...
        get (o, f, i) {
            ...
            return r.length ? i ? p35.create(r.concat(n.ranges)) : p35.create(r) : n;
        }
    } : null;
}
function L10(e) {
    ...
    return k2.mouseSelectionStyle.of((t, n)=>l(n) ? p23(t, n) : null
    );
}
var st2 = 0, f8 = class {
    constructor(t, a, l){
    ...
    static defineModifier() {
        let t = new R10;
        return (a)=>a.modified.indexOf(t) > -1 ? a : R10.get(a.base || a, a.modified.concat(t).sort((l, n)=>l.id - n.id
            ))
        ;
    }
}, ot4 = 0, R10 = class {
    ...
    static get(t, a) {
        ...
        let c = L11(a);
        for (let o1 of t.set)for (let h of c)n.push(R10.get(o1, h));
        return s;
    }
};
function ct2(r, t) {
...
function L11(r) {
    ...
    for(let a = 0; a < r.length; a++)for (let l of L11(r.slice(0, a).concat(r.slice(a + 1))))t.push(l);
    return t;
}
function yt2(r) {
    let t = Object.create(null);
...
var X8 = class {
    ...
    constructor(t, a){
        ...
        this.module && s.push(k2.styleModule.of(this.module)), this.extension = s.concat(H15.of(this)), this.fallback = s.concat(U8.of(this));
    }
    match(t, a) {
...
var Y7 = class {
    constructor(t){
        this.markCache = Object.create(null), this.tree = v8(t.state), this.decorations = this.buildDeco(t, K15(t.state));
    }
    update(t) {
        let a = v8(t.state), l = K15(t.state), n = l != t.startState.facet(H15);
    ...
    buildDeco(t, a) {
        if (!a || !this.tree.length) return x3.none;
        let l = new x2;
        for (let { from: n , to: s  } of t.visibleRanges)_9(this.tree, n, s, a, (c, o, h)=>{
            l.add(c, o, this.markCache[h] || (this.markCache[h] = x3.mark({
                class: h
            })));
        });
        return l.finish();
...
var e1 = f8.define, D12 = e1(), w21 = e1(), tt4 = e1(w21), et4 = e1(w21), x36 = e1(), T21 = e1(x36), q14 = e1(x36), g11 = e1(), v13 = e1(g11), d14 = e1(), u7 = e1(), B17 = e1(), C19 = e1(B17), j10 = e1(), i2 = {
    comment: D12,
    lineComment: e1(D12),
    blockComment: e1(D12),
    docComment: e1(D12),
...
var A15 = class {
    ...
    static init(e, i, o) {
        let s = x3.set(e.map((n)=>n.from == n.to || n.from == n.to - 1 && o.doc.lineAt(n.from).to == n.from ? x3.widget({
                widget: new _10(n),
                diagnostic: n
            }).range(n.from) : x3.mark({
                attributes: {
        ...
        return new u8(s, i, p24(s));
    }
};
function p24(t, e = null, i = 0) {
    let o = null;
...
function I12(t, e) {
    return t.field(c11, !1) ? e : e.concat(v3.appendConfig.of([
        c11,
        k2.decorations.compute([
            c11
        ], (i)=>{
            let { selected: o , panel: s  } = i.field(c11);
            return !o || !s || o.from == o.to ? x3.none : x3.set([
...
var T22 = v3.define(), S22 = v3.define(), M21 = v3.define(), c11 = B1.define({
    create () {
        return new u8(x3.none, null, null);
    },
    update (t, e) {
        if (e.docChanged) {
            ...
            if (t.selected) {
                ...
                o = p24(i, t.selected.diagnostic, s) || p24(i, null, s);
            }
            t = new u8(i, t.panel, o);
        }
        for (let i of e.effects)i.is(T22) ? t = u8.init(i.value, t.panel, e.state) : i.is(S22) ? t = new u8(t.diagnostics, i.value ? k43.open : null, t.selected) : i.is(M21) && (t = new u8(t.diagnostics, t.panel, i.value));
        return t;
    },
    provide: (t)=>[
            b8.from(t, (e)=>e.panel
            ),
            k2.decorations.from(t, (e)=>e.diagnostics
            )
        ]
});
var Q13 = x3.mark({
...
var te6 = (t)=>{
...
], O13 = z3.fromClass(class {
    constructor(t){
        this.view = t, this.timeout = -1, this.set = !0;
        let { delay: e  } = t.state.facet(w22);
    ...
    run() {
        ...
        if (t < this.lintTime - 10) setTimeout(this.run, this.lintTime - t);
            ...
            this.set = !1;
            let { state: e  } = this.view, { sources: i  } = e.facet(w22);
    ...
    update(t) {
        let e = t.state.facet(w22);
        (t.docChanged || e != t.startState.facet(w22)) && (this.lintTime = Date.now() + e.delay, this.set || (this.set = !0, this.timeout = setTimeout(this.run, e.delay)));
    }
    force() {
...
function G7(t, e, i) {
    ...
    return s3("li", {
        ...
        let l = (g)=>{
            g.preventDefault();
            let x = p24(t.state.field(c11).diagnostics, e);
...
var _10 = class extends Q1 {
        ...
        let i = (s)=>{
            if (s.keyCode == 27) B18(this.view), this.view.focus();
                ...
                for(let l = 0; l < r.length; l++)if (r[l].toUpperCase().charCodeAt(0) == s.keyCode) {
                    let a = p24(this.view.state.field(c11).diagnostics, n);
    ...
    update() {
        ...
        for(e.between(0, this.view.state.doc.length, (r, l, { spec: a  })=>{
            ...
            d < 0 ? (f = new L12(this.view, a.diagnostic), this.items.splice(o, 0, f), s = !0) : (f = this.items[d], d > o && (this.items.splice(o, d - o), s = !0)), i && f.diagnostic == i.diagnostic ? f.dom.hasAttribute("aria-selected") || (f.dom.setAttribute("aria-selected", "true"), n = f) : f.dom.hasAttribute("aria-selected") && f.dom.removeAttribute("aria-selected"), o++;
        }); o < this.items.length && !(this.items.length == 1 && this.items[0].diagnostic.from < 0);)s = !0, this.items.pop();
        this.items.length == 0 && (this.items.push(new L12(this.view, {
            from: -1,
            to: -1,
            severity: "info",
    ...
    moveSelection(e) {
        ...
        let i = this.view.state.field(c11), o = p24(i.diagnostics, this.items[e].diagnostic);
...
var oe6 = k2.baseTheme({
    ...
    ".cm-lintRange-error": {
        backgroundImage: P31("#d11")
    },
    ".cm-lintRange-warning": {
        backgroundImage: P31("orange")
    },
    ".cm-lintRange-info": {
        backgroundImage: P31("#999")
    },
    ".cm-lintRange-active": {
...
var le4 = K13({
    ...
    update (t, e) {
        t = t.map(e.changes);
        for (let i of e.effects)i.is(T22) && (t = re9(e.state.doc, i.value));
        return t;
    }
}), R11 = v3.define(), z18 = B1.define({
    create () {
        return null;
    },
    update (t, e) {
        ...
        })), e.effects.reduce((i, o)=>o.is(R11) ? o.value : i
        , t);
    },
    provide: (t)=>k15.from(t)
}), ae7 = k2.baseTheme({
    ".cm-gutter-lint": {
        width: "1.4em",
        "& .cm-gutterElement": {
...
var m27 = class {
    ...
    static start(t, e, s = 0) {
        ...
        return new m27(t, [], e, s, s, 0, [], 0, i ? new w23(i, i.start) : null, 0, null);
    }
    get context() {
    ...
    split() {
        ...
        return new m27(this.p, this.stack.slice(), this.state, this.reducePos, this.pos, this.score, s, i, this.curContext, this.lookAhead, t);
    }
    recoverByDelete(t, e) {
    ...
    updateContext(t) {
        if (t != this.curContext.context) {
            let e = new w23(this.curContext.tracker, t);
...
var D14 = class {
    ...
    static create(t, e = t.bufferBase + t.buffer.length) {
        return new x40(t, e, e - t.bufferBase);
    }
    maybeNext() {
    ...
    fork() {
        return new x40(this.stack, this.pos, this.index);
    }
}, b20 = class {
    constructor(){
...
P32.prototype.contextual = P32.prototype.fallback = P32.prototype.extend = !1;
var J14 = class {
    constructor(t, e = {
    }){
...
var p25 = typeof process != "undefined" && /\bparse\b/.test(process.env.LOG), C20 = null, z19;
(function(o) {
...
var F18 = class {
    ...
    nextFragment() {
        ...
        if (t) {
            for(this.safeFrom = t.openStart ? O14(t.tree, t.from + t.offset, 1) - t.offset : t.from, this.safeTo = t.openEnd ? O14(t.tree, t.to + t.offset, -1) - t.offset : t.to; this.trees.length;)this.trees.pop(), this.start.pop(), this.index.pop();
    ...
    addActions(t, e, s, i) {
        ...
        for(let a = 0; a < 2; a++)for(let l = r.stateSlot(h, a ? 2 : 1);; l += 3){
            if (n[l] == 65535) if (n[l + 1] == 1) l = k44(n, l + 2);
            else {
                i == 0 && n[l + 1] == 2 && (i = this.putAction(k44(n, l + 1), e, s, i));
                break;
            }
            n[l] == e && (i = this.putAction(k44(n, l + 1), e, s, i));
        }
        return i;
    }
}, L14;
...
var $16 = class {
    constructor(t, e, s, i){
        ...
        let { from: h  } = i[0];
        this.stacks = [
            m27.start(this, t.top[0], h)
        ], this.fragments = s.length && this.stream.end - h > t.bufferLength * 4 ? new F18(s, t.nodeSet) : null;
    }
    get parsedPos() {
    ...
    advance() {
        ...
        if (!s.length) {
            ...
            if (this.parser.strict) throw p25 && i && console.log("Stuck with token " + (this.tokens.mainToken ? this.parser.getName(this.tokens.mainToken.value) : "none")), new SyntaxError("No parse at " + e);
    ...
    advanceStack(t, e, s) {
        let i = t.pos, { parser: h  } = this, r = p25 ? this.stackID(t) + " -> " : "";
        ...
        if (this.fragments) {
            ...
            for(let f = this.fragments.nodeAt(i); f;){
                ...
                if (c > -1 && f.length && (!l || (f.prop(y10.contextHash) || 0) == u)) return t.useNode(f, c), p25 && console.log(r + this.stackID(t) + ` (via reuse of ${h.getName(f.type.id)})`), !0;
                if (!(f instanceof P12) || f.children.length == 0 || f.positions[0] > 0) break;
                let d = f.children[0];
                if (d instanceof P12 && f.positions[0] == 0) f = d;
                else break;
            }
        }
        let n = h.stateSlot(t.state, 4);
        if (n > 0) return t.reduce(n), p25 && console.log(r + this.stackID(t) + ` (via always-reduce ${h.getName(n & 65535)})`), !0;
        ...
        for(let l = 0; l < a.length;){
            ...
            if (g.apply(u, f, c), p25 && console.log(r + this.stackID(g) + ` (via ${(u & 65536) == 0 ? "shift" : `reduce of ${h.getName(u & 65535)}`} for ${h.getName(f)} @ ${i}${g == t ? "" : ", split"})`), d) return !0;
    ...
    advanceFully(t, e) {
        ...
        for(;;){
            ...
            if (t.pos > s) return R13(t, e), !0;
        }
    }
    runRecovery(t, e, s) {
        let i = null, h = !1;
        for(let r = 0; r < t.length; r++){
            let n = t[r], a = e[r << 1], l = e[(r << 1) + 1], u = p25 ? this.stackID(n) + " -> " : "";
            if (n.deadEnd && (h || (h = !0, n.restart(), p25 && console.log(u + this.stackID(n) + " (restarted)"), this.advanceFully(n, s)))) continue;
            let f = n.split(), c = u;
            for(let d = 0; f.forceReduce() && d < 10 && (p25 && console.log(c + this.stackID(f) + " (via force-reduce)"), !this.advanceFully(f, s)); d++)p25 && (c = this.stackID(f) + " -> ");
            for (let d1 of n.recoverByInsert(a))p25 && console.log(u + this.stackID(d1) + " (via recover-insert)"), this.advanceFully(d1, s);
            this.stream.end > n.pos ? (l == n.pos && (l++, a = 0), n.recoverByDelete(a, l), p25 && console.log(u + this.stackID(n) + ` (via recover-delete ${this.parser.getName(a)})`), R13(n, s)) : (!i || i.score < n.score) && (i = n);
        }
        return i;
    }
    stackToTree(t) {
        return t.close(), P12.build({
            buffer: x40.create(t),
...
, Q14 = class {
    constructor(t){
        this.start = t.start, this.shift = t.shift || T25, this.reduce = t.reduce || T25, this.reuse = t.reuse || T25, this.hash = t.hash || (()=>0
        ), this.strict = t.strict !== !1;
    }
}, v14 = class extends Ae2 {
    constructor(t){
        super();
        ...
        this.states = A16(t.states, Uint32Array), this.data = A16(t.stateData), this.goto = A16(t.goto), this.maxTerm = t.maxTerm, this.tokenizers = t.tokenizers.map((n)=>typeof n == "number" ? new P32(r, n) : n
    ...
    hasAction(t, e) {
        ...
        for(let i = 0; i < 2; i++)for(let h = this.stateSlot(t, i ? 2 : 1), r;; h += 3){
            if ((r = s[h]) == 65535) if (s[h + 1] == 1) r = s[h = k44(s, h + 2)];
            else {
                if (s[h + 1] == 2) return k44(s, h + 2);
                break;
            }
            if (r == e || r == 0) return k44(s, h + 1);
        }
        return 0;
    }
    stateSlot(t, e) {
    ...
    validAction(t, e) {
        ...
        for(let s = this.stateSlot(t, 1);; s += 3){
            if (this.data[s] == 65535) if (this.data[s + 1] == 1) s = k44(this.data, s + 2);
            else return !1;
            if (e == k44(this.data, s + 1)) return !0;
        }
    }
    nextStates(t) {
        let e = [];
    ...
    configure(t) {
        let e = Object.assign(Object.create(v14.prototype), this);
...
var s11 = 93, W10 = 1, y46 = 94, c16 = 95, r22 = 2, S24 = [
    9,
    10,
    11,
    12,
    ...
    8287,
    12288
], R14 = 58, l2 = 40, X9 = 95, d15 = 91, $18 = 45, p31 = 46, f12 = 35, T26 = 37;
function t19(O) {
...
var _11 = new J14((O, Q)=>{
    ...
    if (S24.includes(O.peek(-1))) {
        let { next: Q  } = O;
        (t19(Q) || Q == X9 || Q == f12 || Q == p31 || Q == d15 || Q == R14 || Q == $18) && O.acceptToken(s11);
    }
}), h4 = new J14((O)=>{
    if (!S24.includes(O.peek(-1))) {
        let { next: Q  } = O;
        if (Q == T26 && (O.advance(), O.acceptToken(W10)), t19(Q)) {
            do O.advance();
            while (t19(O.next))
            O.acceptToken(W10);
        }
...
var p32 = [
    ...
    let { state: o , pos: i  } = a, t = v8(o).resolveInner(i, -1);
...
function L15() {
    return new J10(m30, q15);
}
var W11 = 53, _12 = 1, m32 = 54, Z11 = 2, V15 = 55, Y8 = 3, $19 = 4, p33 = 5, P36 = 6, i3 = 7, E24 = 8, j14 = 9, y47 = 10, R15 = 56, D15 = 11, G9 = 12, T27 = 57, U12 = 18, L16 = 27, N12 = 30, A17 = 33, z21 = 35, I15 = 0, M25 = {
    area: !0,
    base: !0,
    br: !0,
    col: !0,
...
var Q15 = null, w25 = null, q17 = 0;
function g13(e, O) {
    let a = e.pos + O;
    if (q17 == a && w25 == e) return Q15;
    let r = e.peek(O);
    for(; b25(r);)r = e.peek(++O);
    let t = "";
    for(; F19(r);)t += String.fromCharCode(r), r = e.peek(++O);
    return w25 = e, q17 = a, Q15 = t || (r == B20 || r == J16 ? void 0 : null);
}
var v15 = 60, l3 = 62, x42 = 47, B20 = 63, J16 = 33;
function X10(e, O) {
...
var H19 = [
    ...
    if (e.next != v15) {
        e.next < 0 && O.context && e.acceptToken(R15);
        return;
    }
    e.advance();
    let a = e.next == x42;
    ...
    let r = g13(e, 0);
    if (r === void 0) return;
    if (!r) return e.acceptToken(a ? D15 : $19);
    let t = O.context ? O.context.name : null;
    if (a) {
        if (r == t) return e.acceptToken(E24);
        if (t && K17[t]) return e.acceptToken(R15, -2);
        if (O.dialectEnabled(I15)) return e.acceptToken(j14);
        for(let s = O.context; s; s = s.parent)if (s.name == r) return;
        e.acceptToken(y47);
    } else {
        if (r == "script") return e.acceptToken(p33);
        if (r == "style") return e.acceptToken(P36);
        if (r == "textarea") return e.acceptToken(i3);
        t && d18[t] && d18[t][r] ? e.acceptToken(R15, -1) : e.acceptToken($19);
    }
}, {
    contextual: !0
}), Oe5 = new J14((e, O)=>{
...
function c18(e, O, a) {
    ...
    return new J14((t)=>{
        for(let s = 0, k = 0, n = 0;; n++){
            ...
            if (s == 0 && t.next == v15 || s == 1 && t.next == x42 || s >= 2 && s < r && t.next == e.charCodeAt(s - 2)) s++, k++;
...
var ae8 = c18("script", W11, _12), se7 = c18("style", m32, Z11), ke5 = c18("textarea", V15, Y8), ue8 = v14.deserialize({
    version: 13,
...
function Re2(e) {
    ...
    return Ne1((t, s)=>{
        let k = t.type.id;
        return k == L16 ? f13(t, s, O) : k == N12 ? f13(t, s, a) : k == A17 ? f13(t, s, r) : null;
    });
}
var W12 = 275, T28 = 1, o1 = 2, P37 = 276, Z12 = 277, p34 = 278, X11 = 279, r32 = 3, R16 = 281, n2 = 282, V16 = 4, _13 = 5, j15 = 1, q19 = [
    9,
    10,
    11,
    12,
    ...
    8287,
    12288
], Y9 = 125, y48 = 123, G10 = 59, S25 = 47, u13 = 42, x43 = 43, l4 = 45, f14 = 36, s12 = 96, d19 = 92, v16 = new Q14({
    start: !1,
    shift (O, Q) {
        return Q == V16 || Q == _13 || Q == R16 ? O : Q == n2;
    },
    strict: !1
}), b26 = new J14((O, Q)=>{
    let { next: $  } = O;
    ...
    let { next: $  } = O, a;
    q19.indexOf($) > -1 || $ == S25 && ((a = O.peek(1)) == S25 || a == u13) || $ != Y9 && $ != G10 && $ != -1 && !Q.context && Q.canShift(W12) && O.acceptToken(W12);
}, {
    contextual: !0
}), w27 = new J14((O, Q)=>{
    let { next: $  } = O;
    if (($ == x43 || $ == l4) && (O.advance(), $ == O.next)) {
        O.advance();
        let a = !Q.context && Q.canShift(T28);
        O.acceptToken(a ? T28 : o1);
    }
}, {
    contextual: !0
}), k45 = new J14((O)=>{
    for(let Q = !1, $ = 0;; $++){
        ...
        if (a < 0) {
            ...
            $ ? O.acceptToken(P37) : O.acceptToken(p34, 1);
            break;
        } else if (a == y48 && Q) {
            $ == 1 ? O.acceptToken(Z12, 1) : O.acceptToken(P37, -1);
            break;
        } else if (a == 10 && $) {
            O.advance(), O.acceptToken(P37);
            break;
...
function A19(t = {
    ...
    let r = t.jsx ? t.typescript ? J18 : I16 : t.typescript ? v17 : l5;
...
var y49 = [
    ...
    "aria-valuenow": null,
    "aria-valuetext": null
}, J21 = Object.keys(v18), q20 = Object.keys($21);
...
function j17(l, a, n, r) {
    ...
    return {
        from: n,
        to: r,
        options: O40(l.doc, a).map((o)=>({
                label: o,
                type: "type"
            })
        ).concat(x44(l.doc, a).map((o, u)=>({
                label: "/" + o,
                apply: "/" + o + t,
                type: "type",
                boost: 99 - u
...
function K18(l, a, n) {
    let r = [], t = 0;
    for (let o of O40(l.doc, a))r.push({
        label: "<" + o,
        type: "type"
    });
    for (let o1 of x44(l.doc, a))r.push({
        label: "</" + o1 + ">",
        type: "type",
        boost: 99 - t++
    });
...
function Q27(l, a, n, r) {
    let t = T31(a), o = t ? v18[b27(l.doc, t)] : null, u = o && o.attrs ? Object.keys(o.attrs).concat(q20) : q20;
    return {
        from: n,
        to: r,
        options: u.map((d)=>({
...
function X12(l, a, n, r) {
    ...
    if (o) {
        ...
        if (!p) {
            let s = T31(a), i = s ? v18[b27(l.doc, s)] : null;
...
function Y10(l) {
    let { state: a , pos: n  } = l, r = v8(a).resolveInner(n), t = r.resolve(n, -1);
...
var ee8 = k2.inputHandler.of((l, a, n, r)=>{
    if (l.composing || l.state.readOnly || a != n || r != ">" && r != "/" || !N13.isActiveAt(l.state, a, -1)) return !1;
    let { state: t  } = l, o = t.changeByRange((u)=>{
        var d, h, p;
        let { head: s  } = u, i = v8(t).resolveInner(s, -1), f;
