 ...
 */
export declare function assertContextRunning(context: import("../context/BaseContext.d.ts").BaseContext): void;
/**
 ...
 */
export declare function assertUsedScheduleTime(time?: import("../type/Units.d.ts").Time): void;
/**
