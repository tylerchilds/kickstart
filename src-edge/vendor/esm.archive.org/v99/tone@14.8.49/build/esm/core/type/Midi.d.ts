import { FrequencyClass, FrequencyUnit } from "./Frequency.d.ts";
import { TimeValue } from "./TimeBase.d.ts";
import { Hertz, Interval, MidiNote, Seconds, Ticks } from "./Units.d.ts";
/**
