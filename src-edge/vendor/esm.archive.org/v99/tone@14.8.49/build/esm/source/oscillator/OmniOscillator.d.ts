import { Cents, Degrees, Frequency, Seconds, Time } from "../../core/type/Units.d.ts";
import { Signal } from "../../signal/Signal.d.ts";
import { Source } from "../Source.d.ts";
import { AMOscillator } from "./AMOscillator.d.ts";
import { FatOscillator } from "./FatOscillator.d.ts";
import { FMOscillator } from "./FMOscillator.d.ts";
import { Oscillator } from "./Oscillator.d.ts";
import { OmniOscillatorOptions, OmniOscillatorType, ToneOscillatorInterface, ToneOscillatorType } from "./OscillatorInterface.d.ts";
import { PulseOscillator } from "./PulseOscillator.d.ts";
import { PWMOscillator } from "./PWMOscillator.d.ts";
export { OmniOscillatorOptions } from "./OscillatorInterface.d.ts";
/**
