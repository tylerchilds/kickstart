...
import { FatConstructorOptions, FatOscillatorOptions, ToneOscillatorInterface, ToneOscillatorType } from "./OscillatorInterface.d.ts";
export { FatOscillatorOptions } from "./OscillatorInterface.d.ts";
/**
