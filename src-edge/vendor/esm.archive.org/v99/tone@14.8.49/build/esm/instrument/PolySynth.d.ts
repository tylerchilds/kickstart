import { Frequency, NormalRange, Time } from "../core/type/Units.d.ts";
import { RecursivePartial } from "../core/util/Interface.d.ts";
import { Instrument, InstrumentOptions } from "./Instrument.d.ts";
import { MembraneSynth, MembraneSynthOptions } from "./MembraneSynth.d.ts";
import { FMSynth, FMSynthOptions } from "./FMSynth.d.ts";
import { AMSynth, AMSynthOptions } from "./AMSynth.d.ts";
import { MonoSynth, MonoSynthOptions } from "./MonoSynth.d.ts";
import { MetalSynth, MetalSynthOptions } from "./MetalSynth.d.ts";
